    ...
    class PieLabel extends Control {
        ...
        ak(a) {
            if (a.a.az == 3) {
                ...
                let e = GeometryUtil.q(d, this.ai, this.ah.a2 + a.a.db);
                let f = a.b4.width;
        ...
        am() {
            ...
            let a;
            let b = this.ah.ai.dc;
            let c = GeometryUtil.q(this.ah.b6(), this.ai, this.ah.a2);
            this.ap.an = c.x;
            this.ap.ap = c.y;
        ...
        an() {
            ...
            let f = GeometryUtil.q(a, this.ai, this.ah.a2);
            let g = GeometryUtil.q(a, this.ai, this.ah.a2 + this.ah.ai.db / 2);
            let h;
            let i;
            let j;
            let k = e;
            ...
            if (d > 0) {
                ...
                if (d < l) {
                    ...
                    let q = GeometryUtil.j(f, i) / GeometryUtil.j(f, j);
                    h.x = f.x + (h.x - f.x) * q;
                    h.y = f.y + (h.y - f.y) * q;
                }
                else {
...
export let PieChartBase = /*@__PURE__*/ (() => {
    class PieChartBase extends Control {
        ...
        ca(a, b) {
            ...
            let g = false;
            let h = false;
            let i = GeometryUtil.q(d, e, c.a2);
            let j = GeometryUtil.q(d, f, c.a2);
        ...
        static g8(a) {
            ...
            for (let c = 0; c < a.count; c++) {
                let d = a._inner[c];
                let e = d.ah;
                let f = GeometryUtil.q(e.b7, d.ai, e.a2);
                b[c] = f.y;
            }
        ...
        gq() {
            ...
            for (let c = 0; c < a; c++) {
                ...
                let f;
                let g = null;
                if (c == a - 1 && this.cn.count > 0) {
                    f = this.fh();
                    e = true;
                    if (this.cb() || this.ap != null || this.as != null) {
                        let h = ((() => {
                            let $ret = new PieSliceDataContext();
                            $ret.series = this;
                            $ret.item = e ? this.cm : this.bm.item(this.co._inner[c]);
                            $ret.percentValue = this.c9(this.bx.item(c));
                            $ret.isOthersSlice = e;
                            return $ret;
                        })());
                        if (f != null) {
                    ...
                    if (this.br != null && this.br.count >= this.co.count) {
                        f = this.br.item(this.co._inner[c]);
                    }
                    else {
                        f = null;
                    }
                    g = (this.bs != null && this.bs.count > 0) ? this.bs.item(this.co._inner[c]) : null;
                    if (this.cb() || this.ap != null || this.as != null) {
                        let j = ((() => {
                            let $ret = new PieSliceDataContext();
                            $ret.series = this;
                        ...
                        if (null == formattedLabel_ && this.br != null && this.br.count > 0) {
                            f = this.br.item(this.co._inner[c]);
                        }
                        else {
                            f = formattedLabel_;
                ...
                if (this.br != null && this.br.count > 0) {
                    let l = this.bw.item(c);
                    let m = this.bx.item(c);
                    m.aj = l;
                    ...
                    if (this.hc == null) {
                        l.dataContext = e ? this.cm : this.bm.item(this.co._inner[c]);
                        l.ak(this.a4);
                    }
                    else {
                    }
        ...
        gz() {
            ...
            for (let i of fromEnum(this.bx.a)) {
                let j = GeometryUtil.p(a.width, a.height, true, (i.a3 + i.ax) / 2, f * this.c0);
                i.aw = true;
                i.a1 = this.c1;
                i.a0 = this.c1;
                i.a2 = f;
        ...
        gx() {
            ...
            for (let g of fromEnum(this.bw.a)) {
                let h = g.ah;
                if (h == null) {
                    continue;
                }
                ...
                if (this.az == 1 || this.az == 4) {
                    let l = h.a2 * h.a1 / 100;
                    let m = GeometryUtil.q(i, g.ai, h.a2 - (h.a2 - l) / 2);
                ...
                if (this.az == 2 || this.az == 4) {
                    let o = PieChartBase.c7(i, h.a2, g);
                    let p = GeometryUtil.q(i, g.ai, o);
                ...
                h.au = false;
                let r = GeometryUtil.q(i, g.ai, h.a2 + this.db);
                g.ag = 3;
                g._visibility = 0;
                g.al();
                if (g.ai < 90 && g.ai >= 0) {
        ...
        static c7(a, b, c) {
            ...
            let e = 1;
            let f = GeometryUtil.q({ $type: Point_$type, x: 0, y: 0 }, c.ai, e);
            let g = PieChartBase.i5(c);
            let h = Math.sqrt(g.x * g.x + g.y * g.y);
            let i = { $type: Point_$type, x: g.x / h, y: g.y / h };
            let j = PieChartBase.c8(f, i);
            let k = h / b;
            let l = j * k;
            let m = l;
            let n = GeometryUtil.i({ $type: Point_$type, x: 0, y: 0 }, f);
            let o = GeometryUtil.i({ $type: Point_$type, x: 0, y: 0 }, i);
            if (o < n) {
                m = -m;
            }
            let p = GeometryUtil.q(a, (d + m) * 180 / Math.PI, b);
            let q = PieChartBase.i4(c, p);
            let r = Math.sqrt((q.x - a.x) * (q.x - a.x) + (q.y - a.y) * (q.y - a.y));
            let s = r - 5;
            return s;
        }
        static i4(a, b) {
            let c = GeometryUtil.m(a.ai);
            let d = a.ao.width / 2;
            let e = a.ao.height / 2;
            if (c >= 0 && c <= 90) {
        ...
        gy() {
            ...
            for (let a of fromEnum(this.bx.a)) {
                ...
                b.content = ((() => {
                    ...
                    $ret.legendLabel = a.isOthersSlice ? this.fh() : a.bf != null ? a.bf : (c != null ? c.toString() : null);
                    $ret.percentValue = this.c9(a);
                    $ret.isOthersSlice = a.isOthersSlice;
                    return $ret;
                })());
                let f = b.content;
                if (this.cc() || this.aq != null || this.ar != null) {
                    let g = null;
                    if (this.cc()) {
                        g = this.a6(b.content);
                    }
        ...
        bl() {
            ...
            this.a4.ao(a);
            for (let b = 0; b < this.bx.count; b++) {
                let c = this.bx.item(b).am();
                a.slices.add(c);
        ...
        hb() {
            ...
            if (this.bk == 1) {
                if (a != 0) {
                    let b = this.bx.a._inner[this.selectedSlices._inner[a - 1]];
                    if (b.isOthersSlice) {
                        this.selectedItem = ((() => {
    ...
    PieChartBase.hp = DependencyProperty.i("InnerExtent", Number_$type, PieChartBase.$, new PropertyMetadata(2, 0, (a, b) => a.gu("InnerExtent", b.oldValue, b.newValue)));
    PieChartBase.h0 = DependencyProperty.i("LabelTemplate", DataTemplate.$, PieChartBase.$, new PropertyMetadata(2, null, (a, b) => a.gu("LabelTemplate", b.oldValue, b.newValue)));
    PieChartBase.io = DependencyProperty.i("SelectedItem", Base.$, PieChartBase.$, new PropertyMetadata(1, (a, b) => {
...
export let Slice = /*@__PURE__*/ (() => {
    class Slice extends ContentControl {
        ...
        az() {
            let a = Math.abs(PieChartBase.dh(this.ax - this.a3)) == 360;
            if (a) {
                return this.a2;
            }
            return this.a2;
        ...
        cb() {
            let a = (this.ai != null && this.ai.b8) ? true : false;
            let b = this.az();
        ...
        bk() {
            ...
            let k = Math.abs(PieChartBase.dh(this.ax - this.a3)) == 360;
            if (k) {
                this.cc = this.b8;
                if (this.a0 == 0) {
                    let l = ((() => {
            ...
            if (ar && this.b8.height > 0 && this.b8.width > 0 && !b.containsRect(aq)) {
                ...
                at.intersect(as);
                let au = GeometryUtil.m((this.a3 + this.ax) / 2);
                ...
                let az = GeometryUtil.p(this.ai.i9.width, this.ai.i9.height, true, au, this.a2 * this.ai.c0 - ay);
