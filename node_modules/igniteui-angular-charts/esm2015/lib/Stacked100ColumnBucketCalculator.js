...
export let Stacked100ColumnBucketCalculator = /*@__PURE__*/ (() => {
    class Stacked100ColumnBucketCalculator extends StackedColumnBucketCalculator {
        ...
        getBucket1(a, b, c, d, e, f) {
            let g = typeCast(StackedSeriesBase.$, this.c.cy);
            let h = [NaN, NaN, NaN];
            ...
            let q = 0;
            let r = Math.min(g.aac != null ? g.aac.length : 0, g.aab != null ? g.aab.length : 0);
            let s = c * this.d;
            let t = Math.min(s + this.d - 1, r - 1);
            if (s <= t) {
                for (let u = s; u <= t; ++u) {
                    k = a.valueColumn.item(u);
                    q = Math.abs(g.aac[u]) + g.aab[u];
                    if (k < l) {
            ...
            let v = new ScalerParams(0, d, e, i.fragmentYAxis.ch, j);
            h = [f.f._inner[b - this.e][0], i.fragmentYAxis.ek(n, v), i.fragmentYAxis.ek(m, v)];
            return h;
        }
    }
