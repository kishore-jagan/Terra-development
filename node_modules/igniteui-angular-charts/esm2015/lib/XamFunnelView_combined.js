...
export let XamFunnelChart = /*@__PURE__*/ (() => {
    class XamFunnelChart extends Control {
        constructor() {
            ...
            this.b6 = null;
            this.b7 = null;
            this.bs = new ObservableCollection$1(Base.$, 0);
            this.bo = new Dictionary$2(Base.$, Base.$, 0);
            this.ce = null;
            this.cd = null;
            ...
            this.bv = NaN;
            let a = this.bs;
            a.collectionChanged = delegateCombine(a.collectionChanged, runOn(this, this.eg));
            this.ar = new MessageHandler();
            this.ar.b(SliceClickedMessage.$, runOn(this, this.ek));
            this.ar.b(SliceMouseMessage.$, runOn(this, this.el));
            this.ar.b(SelectedItemsChangedMessage.$, runOn(this, this.eh));
            this.ap = new MessageChannel();
            this.b4 = (b, c) => this.dx(c.action, c.position, c.count, c.propertyName);
            this.b5 = (b, c) => this.d2(c.action, c.position, c.count, c.propertyName);
            this.ei();
    ...
    XamFunnelChart.ex = DependencyProperty.i("HighlightValueDisplayMode", HighlightedValueDisplayMode_$type, XamFunnelChart.$, new PropertyMetadata(2, enumGetBox(HighlightedValueDisplayMode_$type, 0), (a, b) => a.ed("HighlightValueDisplayMode", b.oldValue, b.newValue)));
