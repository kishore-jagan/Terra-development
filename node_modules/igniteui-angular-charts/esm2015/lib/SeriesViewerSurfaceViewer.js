...
export let SeriesViewerSurfaceViewer = /*@__PURE__*/ (() => {
    class SeriesViewerSurfaceViewer extends DependencyObject {
        ...
        get maximumZoomLevel() {
            if (this.l.hf == 0.0001 && this.l.he == 0.0001) {
                return 0.9;
            }
            else {
                return 1 - Math.max(this.l.hf, this.l.he);
            }
        }
        get isDirty() {
            return this.n;
        ...
        v(a, b, c) {
            ...
            switch (a) {
                case SeriesViewerSurfaceViewer.$$p[0]:
                    ...
                    let d = this.l != null && this.l.c1 != null && this.l.c1.updatingSliderRanges;
                    if (!this.o && !d) {
                        let e = 1 - this.zoomLevel;
                        let f = RectUtil.l(this.l.vl);
                        let g = new Rect(0, f.x - e / 2, f.y - e / 2, e, e);
                        this.l.v1 = SeriesViewerSurfaceViewer.z(this.l.v1, g, this.l.fh(), this.l.fi(), this.worldRect);
                    }
                    this.w();
                    if (this.l.c1 != null) {
                        this.l.c1.pushZoomLevel(this.zoomLevel);
                    }
                    break;
            }
        }
