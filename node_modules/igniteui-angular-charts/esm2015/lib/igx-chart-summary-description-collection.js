...
import { IgxChartSummaryDescription } from "./igx-chart-summary-description";
...
export class IgxChartSummaryDescriptionCollection {
    constructor() {
    ...
    item(index, value) {
        ...
        if (int != null) {
            ...
            if (!ext) {
                ext = new IgxChartSummaryDescription();
...
*/
    ...
    removeAt(index) {
        ...
        if (iv && iv.externalObject) {
            ...
            if (iv) {
                let e = new IgxChartSummaryDescription();
