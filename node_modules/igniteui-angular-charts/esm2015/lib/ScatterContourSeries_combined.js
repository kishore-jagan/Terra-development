...
export let ScatterContourSeries = /*@__PURE__*/ (() => {
    class ScatterContourSeries extends ScatterTriangulationSeries {
        constructor() {
            ...
            this.yk = new LinearContourValueResolver();
        }
        bi() {
        ...
        getDataLegendSeriesContextAt(a, b) {
            ...
            let g = d == null ? NaN : this.iv(d, "ValueMemberPath");
        ...
        y0(a) {
            ...
            c = e.p0;
            b = e.p1;
            let f = new ScalerParams(1, b, c, this.wq.ch);
            f.c = this.getEffectiveViewport1(a);
            let g = new ScalerParams(1, b, c, this.wr.ch);
        ...
        y1() {
            ...
            if (this.yn == null || this.yn.brushes == null || this.yn.brushes.count == 0) {
                ...
                for (let c of fromEnum(this.yn.brushes)) {
                    b.brushes.add(c);
                }
            }
            if (this.yn != null) {
        ...
        hc(a, b, c) {
            return super.hc(a, b, c) && this.yk != null && this.w3 != null && this.w4 != null && this.w0 != null && this.w1 != null && this.w2 != null && this.w3.count > 0 && this.w4.count > 0 && this.w0.count > 0 && this.w1.count > 0 && this.w2.count > 0;
        }
        a1(a, b) {
            let c = this.yl.ca(a, b);
            if (c != null) {
...
export let ScatterContourSeriesView = /*@__PURE__*/ (() => {
    class ScatterContourSeriesView extends SeriesView {
        constructor(a) {
            ...
            this.b1 = null;
            this.b4 = null;
            this.b3 = new List$1(Brush.$, 0);
            this.b0 = null;
            this.b4 = new List$1(Path.$, 0);
            this.b1 = a;
            this.b2 = ((() => {
        ...
        b5(a, b) {
            ...
            for (let e = 0; e < b.length; e++) {
                ...
                if (d != null) {
                    let m = d.getBrushByValue(f, this.b1.yp);
                    if (m == null) {
                        m = this.e.u3;
                    }
                    this.b3.add(m);
                ...
                if (e != null) {
                    for (let f = 0; f < e.c.count; f++) {
                        ...
                        for (let i = 0; i < g._segments.count; i++) {
                            ...
                            if (j != null) {
                                let k = this.b1.ic / 2 + this.b1.is(b);
