...
export let ItemToolTipLayer = /*@__PURE__*/ (() => {
    class ItemToolTipLayer extends AnnotationLayer {
        ...
        xa(a) {
            ...
            if (this.zw != null) {
                if (a.e9) {
                    let b = a.na();
                    if (!Base.equalsStatic(this.zw, b)) {
                        return false;
                    }
                }
                else {
                    if (!Base.equalsStatic(this.zw, a.name)) {
                        return false;
                    }
                }
            }
        ...
        z1(a, b, c, d, e) {
            ...
            if (!this.zp.b9(a, l, i, n)) {
                return;
            }
            let o = this.zp.ck(l, i, n);
            b.i.add1(l);
            b.j.add1(n);
            b.l.add1(i);
            let p = g.x;
    ...
    ItemToolTipLayer.$$p = markDep(DependencyProperty, PropertyMetadata, ItemToolTipLayer, 'raisePropertyChanged', ['SkipUnknownValues:zs:z2', [0, true], 'TargetSeriesName:zw:z3', [2, null], 'TargetSeries:zq:z4', [Series.$, null], 'UseInterpolation:zt:z5', [0, false]]);
    ...
    class ItemToolTipLayerView extends AnnotationLayerView {
        ...
        an(a) {
            ...
            for (let tooltip_ of fromEnum(this.b8.a)) {
                ...
                this.e.bb.addPointerTooltipData(a, c, d, e, f);
            }
        }
        ch(a) {
            this.as();
