...
export let SplineSeriesBase = /*@__PURE__*/ (() => {
    class SplineSeriesBase extends HorizontalAnchoredCategorySeries {
        ...
        ace(a) {
            let b = typeCast(ISortingAxis_$type, this.abu);
        ...
        am(a, b, c, d, e, f) {
            if (a == null || a.cn || this.zm(this.ct) > 1 || this.zm(this.ct) == 0) {
                return super.am(this.yk(), this.yl.f, this.zm(this.ct), this.zn(this.ct), e, f);
            }
            ...
            let m = this.j8(e, f);
            let n = this.j6(e, f);
            let o = truncate(Math.floor(m / this.zm(this.ct)));
            let p = truncate(Math.floor(n / this.zm(this.ct)));
            j = o - this.zn(this.ct);
            k = p - this.zn(this.ct);
            let q = j * i;
            let r = k * i;
            ...
            let u = this.yl.f._inner[j];
            let v = this.yl.f._inner[k];
            let w = new Array(2);
            w[0] = u;
            w[1] = v;
            return w;
        ...
        z1(a, b) {
            ...
            let j = this.w8();
            let k = 0;
            let l = typeCast(ISortingAxis_$type, this.abu);
            if (l != null && l.i$b.count != this.dl.count) {
                return;
            }
            let m = this.acn(f, c, d, e);
            let n = b.cw.d;
            this.acs(b);
            let o = b.cw.f;
            let p = b.cw.e;
        ...
        acs(a) {
            ...
            if ((this.acf == null || this.acf.length != this.valueColumn.count) && b == 1) {
                let e = this.ach == 0 ? NaN : 0;
                if (this.abu != null && typeCast(ISortingAxis_$type, this.abu) !== null && this.abu.i$b != null) {
                    let f = new SafeSortedReadOnlyDoubleCollection(1, this.valueColumn, this.abu.i$b, NaN);
                    d = (g) => f.item(g);
                }
