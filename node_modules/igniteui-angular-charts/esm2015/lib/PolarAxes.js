...
export let PolarAxes = /*@__PURE__*/ (() => {
    class PolarAxes extends Base {
        ...
        e(a, b, c, d, e, f, g, h, i) {
            ...
            let o;
            let p;
            let q = Math.min(this.a.ly, this.a.lx);
            let r = Math.max(this.a.ly, this.a.lx);
            let s = Math.min(this.b.lx, this.b.ly);
            let t = Math.max(this.b.lx, this.b.ly);
            let u = this.a.lk;
            let v = this.a.ch;
            let w = this.b.lk;
            let x = this.b.ch;
