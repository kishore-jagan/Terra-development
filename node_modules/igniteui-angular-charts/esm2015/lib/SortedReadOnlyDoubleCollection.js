...
*/
import { Base, IList$1_$type, Number_$type, toEnum, markType } from "igniteui-angular-core";
import { ReadOnlyCollection$1 } from "igniteui-angular-core";
/**
 * @hidden
 */
export let SortedReadOnlyDoubleCollection = /*@__PURE__*/ (() => {
    class SortedReadOnlyDoubleCollection extends Base {
        constructor(a, b) {
            super();
            this.b = null;
            this.a = null;
            this.b = new ReadOnlyCollection$1(Number_$type, 1, a);
            this.a = b;
        }
        indexOf(a) {
