...
* ```
*/
export let IgxBollingerBandWidthIndicatorComponent = /*@__PURE__*/ (() => {
    class IgxBollingerBandWidthIndicatorComponent extends IgxStrategyBasedIndicatorComponent {
        constructor() {
            super();
        }
