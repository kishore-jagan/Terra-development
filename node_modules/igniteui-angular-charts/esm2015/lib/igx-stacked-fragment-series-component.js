...
import { NamePatcher, brushToString, stringToBrush, toDoubleCollection, fromDoubleCollection, ensureBool, colorToString, stringToColor, ensureEnum, toSpinal, initializePropertiesFromCss, toPoint, fromPoint, fromRect } from "igniteui-angular-core";
import * as i0 from "@angular/core";
/**
 * Represents a non-visual child of StackedSeriesBase.
*/
export let IgxStackedFragmentSeriesComponent = /*@__PURE__*/ (() => {
    class IgxStackedFragmentSeriesComponent {
        constructor() {
            this.__p = null;
        ...
        */
         ...
         * Gets the label displayed before series value in the Data Legend.
        */
        get actualDataLegendGroup() {
            return this.i.cp;
        }
        set actualDataLegendGroup(v) {
            this.i.cp = v;
        }
        /**
         * Gets the label displayed before series value in the Data Legend.
        */
        get actualHighlightedValuesDataLegendGroup() {
            return this.i.cr;
        }
        set actualHighlightedValuesDataLegendGroup(v) {
            this.i.cr = v;
        }
        /**
        ...
        */
        getSeriesValueBoundingBox(world) {
            let iv = this.i.lm(toPoint(world));
            return fromRect(iv);
        }
        /**
        ...
        */
        getSeriesValueMarkerBoundingBox(world) {
            let iv = this.i.lo(toPoint(world));
            return fromRect(iv);
        }
        ...
        getSeriesHighValuePosition(world, useInterpolation, skipUnknowns) {
            let iv = this.i.le(toPoint(world), useInterpolation, skipUnknowns);
            return fromPoint(iv);
        }
        ...
        getSeriesValuePositionFromSeriesPixel(mouse, useInterpolation, skipUnknowns) {
            let iv = this.i.lj(toPoint(mouse), useInterpolation, skipUnknowns);
            return fromPoint(iv);
        }
        ...
        */
        toWorldPosition(seriesPoint) {
            let iv = this.i.lk(toPoint(seriesPoint));
            return fromPoint(iv);
        }
        /**
        ...
        */
        fromWorldPosition(world) {
            let iv = this.i.ld(toPoint(world));
            return fromPoint(iv);
        }
        /**
