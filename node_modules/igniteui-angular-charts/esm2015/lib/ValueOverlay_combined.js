...
export let ValueOverlay = /*@__PURE__*/ (() => {
    class ValueOverlay extends Series {
        ...
        w6() {
            ...
            let e = new ScalerParams(0, a, b, this.wq.ch, d);
        ...
        xr(a, b) {
            ...
            let c = typeCast(CategoryAxisBase.$, this.wq);
            if (c != null && !c.ce) {
                if (this.w9 > c.lh - 1) {
                    return;
                }
            ...
            let g = typeCast(NumericAxisBase.$, this.wq);
            if (g != null) {
        ...
        q5(a, b, c, d) {
            ...
            switch (b) {
                ...
                case ValueOverlay.$$p[13]:
                    let e = typeCast(NumericAxisBase.$, this.wq);
                    if (e != null) {
                        e.c1();
                    }
                    this.rn(true);
        ...
        wv() {
            ...
            let a = typeCast(CategoryAxisBase.$, this.wq);
            if (a != null && a.lh == 0) {
                return false;
            }
            return true;
        ...
        rp(a, b) {
            ...
            let d = this.wq.ek(this.w9, new ScalerParams(0, this.cs.by, a, this.wq.ch, c));
