...
var FragmentBase = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    FragmentBase.prototype.get_e3 = function () {
        return false;
    };
    ...
    FragmentBase.prototype.j0 = function () {
    ...
    FragmentBase.prototype.bn = function () {
        return this.parentSeries;
    };
    FragmentBase.prototype.yk = function () {
        if (this.parentSeries == null) {
            return null;
        }
        return this.parentSeries.fetchXAxis();
    };
    FragmentBase.prototype.acd = function () {
        if (this.parentSeries == null) {
            return this.yq;
        }
        return this.parentSeries.yq;
    };
    FragmentBase.prototype.y0 = function () {
        if (this.parentSeries == null) {
            return null;
        }
        return this.parentSeries.fetchYAxis();
    };
    FragmentBase.prototype.acj = function (a, b, c, d, e, f, g, h) {
        var i = c[0];
        var j = c[1];
    ...
    FragmentBase.prototype.z1 = function (a, b) {
        a.v();
    ...
    FragmentBase.prototype.v6 = function (a, b, c) {
        var _this = this;
        return this.v8(a, b, c, this.acd().r(this.yk(), this.ct.by, this.ct.bx, this.getEffectiveViewport1(this.ct)), this.y0(), this.yk(), runOn(this, this.ack), function (d, e) { return _this.j9(d, e, _this.yk(), runOn(_this, _this.zk), _this.valueColumn != null ? new FragmentBaseValueList(_this) : null); }, function (d, e) { return _this.j7(d, e, _this.yk(), runOn(_this, _this.zk), _this.valueColumn != null ? new FragmentBaseValueList(_this) : null); });
    };
    FragmentBase.prototype.ai = function () {
        return [this.yk(), this.y0()];
    };
    FragmentBase.prototype.ack = function (a, b, c) {
        if (this.c9 == null) {
            return NaN;
        }
        var d = this.getEffectiveViewport1(this.ct);
        var e = new ScalerParams(0, this.c9.vl, this.ct.bx, this.yk().ch, d);
        var f = this.yq.r(this.yk(), this.c9.vl, this.ct.bx, d);
        return this.i5(this.valueColumn != null ? new FragmentBaseValueList(this) : null, a, this.yk(), e, f, runOn(this, this.zk), b, c);
    };
    FragmentBase.prototype.acm = function (a, b, c) {
        var d = this.aaq(c);
        var e = d;
        var f = this.logicalSeriesLink.az;
        var g = f ? this.parentSeries.aak.e : this.parentSeries.aak.d;
        var h = this;
        if (this.bl != null) {
            h = this.bl;
        }
        ...
        for (var k = i; k >= 0; k--) {
            ...
            if (l != null && l.ace != null && l.ace.o.count > 0 && this.ct != null && l.hc(this.ct.bx, this.ct.by, this.ct)) {
                j = true;
                for (var m = l.ace.o.count - 1; m >= 0; m--) {
                    a.add(l.ace.o._inner[m]);
                }
            }
        }
    };
    FragmentBase.prototype.hc = function (a, b, c) {
    ...
    FragmentBase.prototype.aaq = function (a) {
        var b = 0;
        var c = a.by;
        var d = a.bx;
        var e = this.getEffectiveViewport1(a);
        var f = new ScalerParams(0, c, d, this.y0().ch, e);
        f.b = this.iw();
    ...
    FragmentBase.prototype.ax = function (a) {
        return null;
    };
    FragmentBase.prototype.acl = function () {
        if (this.parentSeries == null) {
            return -1;
        }
        ...
        for (var d = b; this.parentSeries.aao ? d >= 0 : d < this.parentSeries.aaf.count; d += c) {
            var e = this.parentSeries.aaf._inner[d];
    ...
    FragmentBase.prototype.acn = function (a) {
        if (a == null) {
        }
    };
    FragmentBase.prototype.q5 = function (a, b, c, d) {
    ...
    FragmentBase.prototype.rp = function (a, b) {
...
var AreaFragment = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    AreaFragment.prototype.bi = function () {
        return new AreaFragment();
    };
    AreaFragment.prototype.cq = function () {
        return new AreaFragmentView(this);
    };
    AreaFragment.prototype.qx = function (a) {
        _super.prototype.qx.call(this, a);
        this.aco = a;
    };
    AreaFragment.prototype.get_et = function () {
        return true;
    };
    AreaFragment.prototype.get_es = function () {
        return true;
    };
    AreaFragment.prototype.yv = function () {
        return 1;
    };
    AreaFragment.prototype.acq = function (a, b) {
        var c = this.aco.dl.an;
        if (this.gw(a, c)) {
            return true;
        }
        var d = this.aco.dm.an;
        if (this.gw(a, d)) {
            return true;
        }
        return false;
    };
    AreaFragment.prototype.gu = function (a, b) {
        if (this.acp(a, b)) {
            return true;
        }
        if (this.acq(a, b)) {
    ...
    AreaFragment.prototype.acp = function (a, b) {
        var c = this.aco.dn.an;
        if (this.gv(a, b, c)) {
            return true;
        }
        var d = this.aco.dp.an;
        if (this.gv(a, b, d)) {
            return true;
        }
        return false;
    ...
    AreaFragment.prototype.o3 = function (a, b) {
        _super.prototype.o3.call(this, a, b);
        var c = b;
        c.dg();
    };
    AreaFragment.prototype.z4 = function (a, b) {
        var _this = this;
        ...
        if (f) {
            var h = new ScalerParams(0, b.by, b.bx, this.abu.ch, e);
        ...
        var i = c.cw.d;
        this.ace.i(c.dl, c.dn, c.dm, c.dp, a.f.count, a.f, true, i, this.ib, function (j, k, l, m, n) { return _this.acm(j, a.f, b); }, 0);
        c.dl._opacity = this.yt.j * this.h7;
        c.dm._opacity = 0.5 * this.yt.j * this.h7;
    };
    AreaFragment.prototype.r7 = function () {
        var a = (typeCast(XamDataChart.$, this.c9));
        if (a != null) {
...
var ColumnFragment = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ColumnFragment.prototype.bi = function () {
        return new ColumnFragment();
    };
    ColumnFragment.prototype.get_ex = function () {
        return true;
    };
    ColumnFragment.prototype.get_fj = function () {
        return true;
    };
    ColumnFragment.prototype.ji = function () {
        if (!isNaN_(this.jh)) {
            return _super.prototype.ji.call(this);
        }
        return Defaults.h;
    };
    ColumnFragment.prototype.yv = function () {
        return 1;
    };
    ColumnFragment.prototype.cq = function () {
        return new ColumnFragmentView(this);
    };
    ColumnFragment.prototype.qx = function (a) {
        _super.prototype.qx.call(this, a);
        this.acp = a;
    };
    ...
    ColumnFragment.prototype.yk = function () {
        return this.fragmentXAxis;
    };
    ColumnFragment.prototype.y0 = function () {
        return this.fragmentYAxis;
    };
    ColumnFragment.prototype.get_eb = function () {
        return true;
    };
    ...
    ColumnFragment.prototype.o3 = function (a, b) {
        _super.prototype.o3.call(this, a, b);
        var c = b;
        if (a && c.dg != null) {
            this.yl.n.clear();
    ...
    ColumnFragment.prototype.ax = function (a) {
        if (this.valueColumn == null || this.valueColumn.count == 0) {
            return null;
        }
        return new AxisRange(this.valueColumn.minimum, this.valueColumn.maximum);
    };
    ColumnFragment.prototype.hc = function (a, b, c) {
        if (this.parentSeries == null) {
            return false;
        }
        return this.parentSeries.aap(this, a, b, this.acr(c));
    };
    ColumnFragment.prototype.g9 = function () {
        return true;
    };
    ColumnFragment.prototype.zm = function (a) {
        if (this.parentSeries != null) {
            return this.parentSeries.zm(this.parentSeries.ct);
        }
        return _super.prototype.zm.call(this, a);
    };
    ColumnFragment.prototype.zn = function (a) {
        if (this.parentSeries != null) {
            return this.parentSeries.zn(this.parentSeries.ct);
        }
        return _super.prototype.zm.call(this, a);
    };
    ColumnFragment.prototype.zo = function (a) {
        if (this.parentSeries != null) {
            return this.parentSeries.zo(this.parentSeries.ct);
        }
        return _super.prototype.zo.call(this, a);
    };
    ColumnFragment.prototype.wh = function (a) {
        ...
        var g = this.am(this.yk(), this.yl.f, this.zm(this.ct), this.zn(this.ct), a, true);
        if (g == null) {
            return Rect.empty;
        }
        var h = g[0];
    ...
    ColumnFragment.prototype.gu = function (a, b) {
        if (this.gx(a, b)) {
            return true;
        }
        if (this.w9(a, b)) {
    ...
    ColumnFragment.prototype.gx = function (a, b) {
        ...
        var d = this.acy(c, this.is(b));
        return d.containsPoint(a);
    };
    ColumnFragment.prototype.acy = function (a, b) {
    ...
    ColumnFragment.prototype.j3 = function (a) {
        ...
        var h = this.wd(this.ct);
        var i = e.en(h.left, f);
        var j = e.en(h.right, f);
    ...
    ColumnFragment.prototype.j1 = function (a) {
        if (this.parentSeries == null) {
            return -1;
        }
        return this.parentSeries.aav(a);
    };
    ColumnFragment.prototype.acj = function (a, b, c, d, e, f, g, h) {
        var i = 0;
        var j = c[0];
        var k = e < i ? c[2] : c[1];
    ...
    ColumnFragment.prototype.acr = function (a) {
        if (a.p) {
    ...
    ColumnFragment.prototype.rm = function (a, b, c, d, e) {
    ...
    ColumnFragment.prototype.z1 = function (a, b) {
        a.v();
        ...
        var d = typeCast(CategorySeriesView.$, this.acr(b));
        a.f.clear();
        if (a.m != null) {
            a.m.clear();
        }
        ...
        var e = d.cw.e;
        var f = d.cw.f;
        var g = this.parentSeries.yq.h.yScaler;
        var h = typeCast(ISortingAxis_$type, this.parentSeries.yq.h.scaler);
        var i = typeCast(NumericAxisBase.$, g) !== null && g.lk;
    ...
    ColumnFragment.prototype.z4 = function (a, b) {
        _super.prototype.z4.call(this, a, b);
        if (this.parentSeries == null) {
            return;
        }
    ...
    ColumnFragment.prototype.q5 = function (a, b, c, d) {
        _super.prototype.q5.call(this, a, b, c, d);
    };
...
var BarFragment = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    BarFragment.prototype.get_ev = function () {
        return true;
    };
    BarFragment.prototype.get_fj = function () {
        return true;
    };
    BarFragment.prototype.get_ex = function () {
        return false;
    };
    BarFragment.prototype.yv = function () {
        return 1;
    };
    ...
    BarFragment.prototype.yk = function () {
        if (this.parentSeries == null) {
            return null;
        }
        return this.parentSeries.fetchYAxis();
    ...
    BarFragment.prototype.ip = function (a) {
        var b = this.c9 != null ? this.c9.vl : Rect.empty;
        var c = this.ct.bx;
        var d = this.wd(this.ct);
        var e = this.getEffectiveViewport1(this.ct);
        var f = this.yk();
        var g = -1;
    ...
    BarFragment.prototype.y0 = function () {
        if (this.parentSeries == null) {
            return null;
        }
        return this.parentSeries.y0();
    };
    BarFragment.prototype.acy = function (a, b) {
        var c = a.left + a.width / 2;
        var d = a.top + a.height / 2;
        var e = c - (a.width / 2);
    ...
    BarFragment.prototype.wh = function (a) {
        if (this.yk() == null) {
            return Rect.empty;
        }
        var b = this.v1(a);
        ...
        var h = this.am(this.yk(), this.yl.f, this.zm(this.ct), this.zn(this.ct), a, true);
        if (h == null) {
            return Rect.empty;
        }
        var i = h[0];
    ...
    BarFragment.prototype.gu = function (a, b) {
        if (this.gx(a, b)) {
            return true;
        }
        if (this.w9(a, b)) {
    ...
    BarFragment.prototype.acj = function (a, b, c, d, e, f, g, h) {
        var i = c[0];
        var j = e < 0 ? c[2] : c[1];
    ...
    BarFragment.prototype.kl = function (a) {
        var b = 0;
    ...
    BarFragment.prototype.j3 = function (a) {
        var b = this.ct.by;
        var c = this.ct.bx;
        if (b.isEmpty || c.isEmpty) {
            return -1;
        ...
        var h = this.barFragmentYAxis.en(g.top, e);
        var i = this.barFragmentYAxis.en(g.bottom, e);
    ...
    BarFragment.prototype.aaq = function (a) {
        var b = 0;
        var c = a.by;
        var d = a.bx;
        var e = this.getEffectiveViewport1(a);
    ...
    BarFragment.prototype.q5 = function (a, b, c, d) {
        _super.prototype.q5.call(this, a, b, c, d);
...
var LineFragmentBucketCalculator = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    LineFragmentBucketCalculator.prototype.getBucket = function (a) {
        ...
        for (var h = b; h <= c; ++h) {
            ...
            var j = Math.abs(g.aac[h]) + g.aab[h];
...
var StackedBucketCalculator = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    StackedBucketCalculator.prototype.getBucket = function (a) {
        ...
        var c = Math.min(b.aac != null ? b.aac.length : 0, b.aab != null ? b.aab.length : 0);
        var d = Math.min(a * this.d, c - 1);
        var e = Math.min(d + this.d - 1, c - 1);
        var f = NaN;
        var g = NaN;
        for (var h = d; h <= e; ++h) {
            var i = Math.min(b.aac[h], b.aab[h]);
            var j = Math.max(b.aac[h], b.aab[h]);
            if (!isNaN_(f)) {
                if (!isNaN_(i)) {
                    f = Math.min(f, i);
                    g = Math.max(g, i);
...
var StackedBarBucketCalculator = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    StackedBarBucketCalculator.prototype.g = function (a) {
        ...
        var h = d.wd(this.c);
        var i = Math.floor(d.yAxis.eo(h.top, g, 0));
        var j = Math.ceil(d.yAxis.eo(h.bottom, g, 0));
        if (!d.yAxis.ch) {
    ...
    StackedBarBucketCalculator.prototype.getBucket1 = function (a, b, c, d, e, f) {
        ...
        var q = Math.min(i.aac != null ? i.aac.length : 0, i.aab != null ? i.aab.length : 0);
        var r = c * this.d;
...
var FragmentBaseValueList = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    FragmentBaseValueList.prototype.item = function (a, b) {
        if (arguments.length === 2) {
            ...
            var e = Math.abs(c.aac[a]) + c.aab[a];
...
var LineFragment = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    LineFragment.prototype.bi = function () {
        return new LineFragment();
    };
    LineFragment.prototype.get_fi = function () {
        return true;
    };
    LineFragment.prototype.zf = function () {
        return true;
    };
    LineFragment.prototype.cq = function () {
        return new LineFragmentView(this);
    };
    LineFragment.prototype.qx = function (a) {
        _super.prototype.qx.call(this, a);
        this.aco = a;
    };
    LineFragment.prototype.acq = function (a, b) {
        var c = this.aco.dk.an;
        if (this.gw(a, c)) {
            return true;
        }
        return false;
    };
    LineFragment.prototype.get_et = function () {
        return true;
    };
    LineFragment.prototype.gu = function (a, b) {
        if (this.acp(a, b)) {
            return true;
        }
        if (this.acq(a, b)) {
    ...
    LineFragment.prototype.acp = function (a, b) {
        var c = this.aco.dl.an;
        if (this.gv(a, b, c)) {
            return true;
        }
    ...
    LineFragment.prototype.o3 = function (a, b) {
        _super.prototype.o3.call(this, a, b);
        var c = b;
        c.dg();
    };
    LineFragment.prototype.z4 = function (a, b) {
        _super.prototype.z4.call(this, a, b);
        ...
        if (k) {
            var m = new ScalerParams(0, b.by, b.bx, this.abu.ch, i);
...
var SplineFragmentBase = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SplineFragmentBase.prototype.p5 = function (a) {
        _super.prototype.p5.call(this, a);
        a.parentSeries = this.parentSeries;
        a.logicalSeriesLink = this.logicalSeriesLink;
    };
    SplineFragmentBase.prototype.get_e3 = function () {
        return false;
    };
    SplineFragmentBase.prototype.preferredCategoryMode = function (a) {
        return 0;
    };
    SplineFragmentBase.prototype.get_e9 = function () {
        return true;
    };
    SplineFragmentBase.prototype.na = function () {
        if (this.logicalSeriesLink != null) {
            return this.logicalSeriesLink.e0;
        }
        return null;
    };
    SplineFragmentBase.prototype.v6 = function (a, b, c) {
        var _this = this;
        return this.v8(a, b, c, this.yq.r(this.yk(), this.ct.by, this.ct.bx, this.getEffectiveViewport1(this.ct)), this.y0(), this.yk(), runOn(this, this.ac1), function (d, e) { return _this.j9(d, e, _this.yk(), runOn(_this, _this.zk), new SplineFragmentBaseValueList(_this)); }, function (d, e) { return _this.j7(d, e, _this.yk(), runOn(_this, _this.zk), new SplineFragmentBaseValueList(_this)); });
    };
    SplineFragmentBase.prototype.ai = function () {
        return [this.yk(), this.y0()];
    };
    SplineFragmentBase.prototype.ac1 = function (a, b, c) {
        if (this.c9 == null) {
            return NaN;
        }
        var d = this.getEffectiveViewport1(this.ct);
    ...
    SplineFragmentBase.prototype.j0 = function () {
        var a = this.parentSeries;
        if (a.index == -1 || a.aak == null || a.aak.f.indexOf(this) == -1) {
            return -1;
        }
    ...
    SplineFragmentBase.prototype.j5 = function () {
        var a = this.parentSeries;
        if (a.index == -1 || a.series.count == 0 || a.series.indexOf(this.logicalSeriesLink) == -1) {
            return -1;
        }
    ...
    SplineFragmentBase.prototype.bn = function () {
        return this.parentSeries;
    };
    SplineFragmentBase.prototype.acj = function (a, b, c, d, e, f, g) {
        var h = b[0];
        var i = b[1];
    ...
    SplineFragmentBase.prototype.hc = function (a, b, c) {
        var d = _super.prototype.hc.call(this, a, b, c);
        var e = typeCast(CategoryAxisBase.$, this.parentSeries.fetchXAxis());
        var f = this.parentSeries.fetchYAxis();
        if (this.parentSeries == null || e == null || e.itemsSource == null || f == null || this.parentSeries.dl == null || e.bi == null || f.bi == null) {
    ...
    SplineFragmentBase.prototype.ax = function (a) {
        return null;
    };
    SplineFragmentBase.prototype.ac2 = function (a, b, c, d, e, f) {
        var _this = this;
        ...
        var k = d.en(2, i) - d.en(1, i);
        var l = this.w8();
        var m = 0;
        var n = this.acn(d, b, c, h);
        var o = function (p) { return Math.abs(_this.parentSeries.aac[p]) + _this.parentSeries.aab[p]; };
    ...
    SplineFragmentBase.prototype.z1 = function (a, b) {
        var _this = this;
        a.v();
        if (this.valueColumn == null || this.parentSeries == null || this.logicalSeriesLink == null) {
            return;
        ...
        var s = function (t) { return Math.abs(_this.parentSeries.aac[t]) + _this.parentSeries.aab[t]; };
    ...
    SplineFragmentBase.prototype.acd = function (a) {
        var _this = this;
        var b = function (c) { return Math.abs(_this.parentSeries.aac[c]) + _this.parentSeries.aab[c]; };
        ...
        var f = a.by;
        var g = a.bx;
        var h = typeCast(ISortingAxis_$type, this.abu);
        var i = 0;
        var j = 0;
        var k = 0;
        var l = this.ib;
        var m = this.wd(this.ct);
        var n = this.abu;
    ...
    SplineFragmentBase.prototype.ace = function (a) {
        var _this = this;
        ...
        var h = this.w8();
        var i = 0;
        var j = function (k) { return Math.abs(_this.parentSeries.aac[k]) + _this.parentSeries.aab[k]; };
    ...
    SplineFragmentBase.prototype.acs = function (a) {
        var _this = this;
        _super.prototype.acs.call(this, a);
        var b = function (c) { return Math.abs(_this.parentSeries.aac[c]) + _this.parentSeries.aab[c]; };
        var c = function (d) { return d; };
        var d = function (e) {
            var f = _this.valueColumn.item(e);
    ...
    SplineFragmentBase.prototype.q5 = function (a, b, c, d) {
        _super.prototype.q5.call(this, a, b, c, d);
        switch (b) {
            case "ActualBrush":
                if (this.logicalSeriesLink != null) {
...
var SplineAreaFragment = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SplineAreaFragment.prototype.bi = function () {
        return new SplineAreaFragment();
    };
    SplineAreaFragment.prototype.cq = function () {
        return new SplineAreaFragmentView(this);
    };
    SplineAreaFragment.prototype.qx = function (a) {
        _super.prototype.qx.call(this, a);
    ...
    SplineAreaFragment.prototype.get_et = function () {
        return true;
    };
    SplineAreaFragment.prototype.get_es = function () {
        return true;
    };
    SplineAreaFragment.prototype.get_fy = function () {
        return true;
    };
    SplineAreaFragment.prototype.yv = function () {
        return 1;
    };
    SplineAreaFragment.prototype.ac5 = function (a, b) {
        var c = this.ac3.dn.an;
        if (this.gw(a, c)) {
            return true;
        }
        var d = this.ac3.dp.an;
        if (this.gw(a, d)) {
            return true;
        }
        return false;
    };
    SplineAreaFragment.prototype.gu = function (a, b) {
        if (this.ac4(a, b)) {
            return true;
        }
        if (this.ac5(a, b)) {
    ...
    SplineAreaFragment.prototype.ac4 = function (a, b) {
        var c = this.ac3.dq.an;
        if (this.gv(a, b, c)) {
            return true;
        }
        var d = this.ac3.dr.an;
        if (this.gv(a, b, d)) {
            return true;
        }
        return false;
    };
    SplineAreaFragment.prototype.o3 = function (a, b) {
        _super.prototype.o3.call(this, a, b);
        var c = b;
        c.di();
    };
    SplineAreaFragment.prototype.z4 = function (a, b) {
        var _this = this;
        _super.prototype.z4.call(this, a, b);
        ...
        if (e) {
            var g = new ScalerParams(0, b.by, b.bx, this.abu.ch, d);
        ...
        this.acx.i(h.dn, h.dq, h.dp, h.dr, a.f.count, a.f, true, i, this.ib, function (j, k, l, m, n) { return _this.ac6(j, a.f, b); }, 1);
    };
    SplineAreaFragment.prototype.rp = function (a, b) {
        _super.prototype.rp.call(this, a, b);
    };
    SplineAreaFragment.prototype.ac6 = function (a, b, c) {
        var d = this.aaq(c);
        var e = d;
        var f = this.logicalSeriesLink.az;
        var g = f ? this.parentSeries.aak.e : this.parentSeries.aak.d;
        ...
        for (var j = h; j >= 0; j--) {
            ...
            if (k != null && k.acx != null && k.acx.o.count > 0 && this.ct != null && k.hc(this.ct.bx, this.ct.by, this.ct)) {
                i = true;
                for (var l = k.acx.o.count - 1; l >= 0; l--) {
                    a.add(k.acx.o._inner[l]);
                }
            }
        }
    };
    SplineAreaFragment.prototype.aaq = function (a) {
        var b = 0;
        var c = a.by;
        var d = a.bx;
        var e = this.getEffectiveViewport1(a);
    ...
    SplineAreaFragment.prototype.r7 = function () {
        var a = (typeCast(XamDataChart.$, this.c9));
        if (a != null) {
            this.h7 = isNaN_(this.ii) ? this.parentSeries.h7 : this.ii;
        }
...
var SplineFragment = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SplineFragment.prototype.bi = function () {
        return new SplineFragment();
    };
    SplineFragment.prototype.get_fy = function () {
        return true;
    };
    SplineFragment.prototype.zf = function () {
        return true;
    };
    SplineFragment.prototype.cq = function () {
        return new SplineFragmentView(this);
    };
    SplineFragment.prototype.qx = function (a) {
        _super.prototype.qx.call(this, a);
        this.ac3 = a;
    };
    SplineFragment.prototype.ac5 = function (a, b) {
        var c = this.ac3.dm.an;
        if (this.gw(a, c)) {
            return true;
        }
        return false;
    };
    SplineFragment.prototype.get_et = function () {
        return true;
    };
    SplineFragment.prototype.gu = function (a, b) {
        if (this.ac4(a, b)) {
            return true;
        }
        if (this.ac5(a, b)) {
    ...
    SplineFragment.prototype.ac4 = function (a, b) {
        var c = this.ac3.dn.an;
        if (this.gv(a, b, c)) {
            return true;
        }
    ...
    SplineFragment.prototype.o3 = function (a, b) {
        _super.prototype.o3.call(this, a, b);
        var c = b;
        c.di();
    };
    SplineFragment.prototype.z4 = function (a, b) {
        _super.prototype.z4.call(this, a, b);
        this.acx.a = typeCast(ISortingAxis_$type, this.xAxis) !== null ? true : false;
...
var StackedSeriesBase = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function StackedSeriesBase() {
        ...
        _this.aaj = null;
        _this.aag = null;
        _this.aaq = new Dictionary$2(String_$type, Boolean_$type, 0);
        _this.aad = null;
        _this.series = new StackedSeriesCollection();
        var a = _this.series;
        a.collectionResetting = delegateCombine(a.collectionResetting, runOn(_this, _this.aa6));
        var b = _this.series;
        b.collectionChanged = delegateCombine(b.collectionChanged, runOn(_this, _this.aa5));
        _this.yq = new StackedSeriesFramePreparer(1, _this, _this.aal, _this, _this, _this.aal.cw);
        _this.aag = new StackedSeriesCollection();
        var c = _this.aag;
        c.collectionChanged = delegateCombine(c.collectionChanged, runOn(_this, _this.aa5));
        var d = _this.aag;
        d.collectionResetting = delegateCombine(d.collectionResetting, runOn(_this, _this.aa0));
        return _this;
    }
    StackedSeriesBase.prototype.qc = function () {
        var e_1, _a;
        try {
            for (var _b = __values(fromEnum(this.aaf)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var a = _c.value;
                a.gw();
            }
        }
    ...
    StackedSeriesBase.prototype.get_fc = function () {
        return false;
    };
    StackedSeriesBase.prototype.getHostReferenceValue = function () {
        return this.iw();
    };
    StackedSeriesBase.prototype.cq = function () {
        return new StackedSeriesView(this);
    };
    StackedSeriesBase.prototype.qx = function (a) {
        _super.prototype.qx.call(this, a);
        this.aal = a;
    };
    StackedSeriesBase.prototype.qy = function (a, b) {
        var e_2, _a;
    ...
    StackedSeriesBase.prototype.ka = function () {
        if (this.series == null) {
            return -1;
        }
        return this.series.count;
    };
    StackedSeriesBase.prototype.pz = function (a) {
        for (var b = 0; b < this.aak.f.count; b++) {
            var c = this.aak.f._inner[b];
            if (!a(c)) {
                break;
            }
        }
    ...
    Object.defineProperty(StackedSeriesBase.prototype, "aak", {
        get: function () {
            if (this.aaj == null) {
    ...
    Object.defineProperty(StackedSeriesBase.prototype, "aaf", {
        get: function () {
    ...
    StackedSeriesBase.prototype.aa0 = function (a, b) {
        var e_3, _a;
        try {
            for (var _b = __values(fromEnum(this.aag)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var c = _c.value;
    ...
    StackedSeriesBase.prototype.aa6 = function (a, b) {
        var e_4, _a;
        try {
            for (var _b = __values(fromEnum(this.series)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var c = _c.value;
    ...
    StackedSeriesBase.prototype.aa5 = function (a, b) {
        var e_5, _a, e_6, _b;
        if (b.oldItems != null) {
            try {
    ...
    StackedSeriesBase.prototype.r0 = function (a) {
        this.c7.c8.c8(a, true, false);
    };
    StackedSeriesBase.prototype.yr = function (a) {
        if (a != null && a.q) {
            if (a.p) {
                ...
                var b = typeCast(CategorySeriesView.$, this.cs);
    ...
    StackedSeriesBase.prototype.z1 = function (a, b) {
        a.v();
        this.aa3();
        this.yr(b).d(a, b);
    };
    StackedSeriesBase.prototype.ro = function (a) {
        _super.prototype.ro.call(this, a);
        this.aak.h(a);
    };
    StackedSeriesBase.prototype.get_gr = function () {
        return false;
    };
    StackedSeriesBase.prototype.o3 = function (a, b) {
        var e_7, _a;
        _super.prototype.o3.call(this, a, b);
        try {
            for (var _b = __values(fromEnum(this.aaf)), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    StackedSeriesBase.prototype.aa1 = function () {
        this.aa3();
    };
    StackedSeriesBase.prototype.aa7 = function () {
    ...
    StackedSeriesBase.prototype.get_aan = function () {
        return false;
    };
    Object.defineProperty(StackedSeriesBase.prototype, "aan", {
        get: function () {
            return this.get_aan();
        },
        enumerable: false,
    ...
    StackedSeriesBase.prototype.gb = function (a) {
        var b = this.dl != null ? this.dl.indexOf(a) : -1;
        var c = this.c9 != null ? this.c9.vl : Rect.empty;
        c = c.copy();
        var d = this.ct.bx;
        ...
        if (b >= 0 && Rect.l_op_Inequality(c, null) && Rect.l_op_Inequality(d, null)) {
            ...
            if (j != null && this.aab != null && b < this.aab.length) {
                ...
                var l = j.ek(this.aab[b], k);
                var m = j.ek(this.aac[b], k);
    ...
    StackedSeriesBase.prototype.ax = function (a) {
        if (this.aac == null || this.aac.length == 0 || this.aab == null || this.aab.length == 0) {
            return null;
        }
        if (a == this.fetchXAxis()) {
            var b = Math.min(this.aac.length, this.aab.length);
    ...
    StackedSeriesBase.prototype.w8 = function () {
        return false;
    };
    StackedSeriesBase.prototype.o9 = function (a, b, c, d) {
        this.aa3();
        this.zg();
        this.rn(true);
    };
    StackedSeriesBase.prototype.aae = function () {
        return this.aal;
    };
    StackedSeriesBase.prototype.aar = function () {
        var a = 0;
        var b = this.ct.by;
        var c = this.ct.bx;
        var d = this.getEffectiveViewport1(this.ct);
    ...
    StackedSeriesBase.prototype.aas = function () {
    ...
    StackedSeriesBase.prototype.aaw = function (a) {
        return this.index < 0 || this.aaf == null || this.aaf.count == 0 ? -1 : this.index + this.aaf.indexOf(a);
    };
    StackedSeriesBase.prototype.aav = function (a) {
        var b = this.c9 != null ? this.c9.vl : Rect.empty;
        var c = this.ct.bx;
        var d = this.getEffectiveViewport1(this.ct);
    ...
    StackedSeriesBase.prototype.aap = function (a, b, c, d) {
        var e = true;
    ...
    StackedSeriesBase.prototype.aa2 = function () {
        var e_8, _a;
    ...
    StackedSeriesBase.prototype.z4 = function (a, b) {
        _super.prototype.z4.call(this, a, b);
    };
    StackedSeriesBase.prototype.aa4 = function (a, b, c, d) {
    };
    StackedSeriesBase.prototype.ay = function (a) {
        ...
        var c = this.wd(this.ct);
        var d = new ScalerParams(0, a, this.c9.v0, b.ch, this.getEffectiveViewport());
        var e = (b.en(c.left, d));
        var f = (b.en(c.right, d));
        if (b.ch) {
            var g = e;
            e = f;
            f = g;
    ...
    StackedSeriesBase.prototype.rr = function () {
        var e_9, _a;
    ...
    StackedSeriesBase.prototype.aa3 = function () {
        var e_10, _a;
        if (this.dl == null) {
            return;
        }
    ...
    StackedSeriesBase.prototype.q5 = function (a, b, c, d) {
        ...
        switch (b) {
            case "SeriesViewer":
                ...
                if (this.aaf != null) {
                    try {
                        for (var _24 = __values(fromEnum(this.aaf)), _25 = _24.next(); !_25.done; _25 = _24.next()) {
                            var e = _25.value;
                            e.af = this.c9;
                        }
                    }
            ...
            case "ItemsSource":
                if (this.aaf != null) {
                    try {
                        for (var _26 = __values(fromEnum(this.aaf)), _27 = _26.next(); !_27.done; _27 = _26.next()) {
                            var f = _27.value;
            ...
            case "HighlightedItemsSource":
                if (this.aaf != null) {
                    try {
                        for (var _28 = __values(fromEnum(this.aaf)), _29 = _28.next(); !_29.done; _29 = _28.next()) {
                            var g = _29.value;
            ...
            case StackedSeriesBase.$$p[2]:
                try {
                    for (var _30 = __values(fromEnum(this.aaf)), _31 = _30.next(); !_31.done; _31 = _30.next()) {
                        var h = _31.value;
                        h.hm();
                    }
                }
            ...
            case "Brush":
                try {
                    for (var _32 = __values(fromEnum(this.aaf)), _33 = _32.next(); !_33.done; _33 = _32.next()) {
                        var i = _33.value;
                        i.f4();
                    }
                }
            ...
            case "DashArray":
                try {
                    for (var _34 = __values(fromEnum(this.aaf)), _35 = _34.next(); !_35.done; _35 = _34.next()) {
                        var j = _35.value;
                        j.f5();
                    }
                }
            ...
            case "HighlightingFadeOpacity":
                try {
                    for (var _36 = __values(fromEnum(this.aaf)), _37 = _36.next(); !_37.done; _37 = _36.next()) {
                        var k = _37.value;
                        k.gb();
                    }
                }
            ...
            case "HighlightedValuesDisplayMode":
                try {
                    for (var _38 = __values(fromEnum(this.aaf)), _39 = _38.next(); !_39.done; _39 = _38.next()) {
                        var l = _39.value;
                        l.ga();
                    }
                }
            ...
            case "DashCap":
                try {
                    for (var _40 = __values(fromEnum(this.aaf)), _41 = _40.next(); !_41.done; _41 = _40.next()) {
                        var m = _41.value;
                        m.f6();
                    }
                }
            ...
            case "IsDropShadowEnabled":
                try {
                    for (var _42 = __values(fromEnum(this.aaf)), _43 = _42.next(); !_43.done; _43 = _42.next()) {
                        var n = _43.value;
                        n.gc();
                    }
                }
            ...
            case "ShadowBlur":
                try {
                    for (var _44 = __values(fromEnum(this.aaf)), _45 = _44.next(); !_45.done; _45 = _44.next()) {
                        var o = _45.value;
                        o.g3();
                    }
                }
            ...
            case "ShadowColor":
                try {
                    for (var _46 = __values(fromEnum(this.aaf)), _47 = _46.next(); !_47.done; _47 = _46.next()) {
                        var p = _47.value;
                        p.g4();
                    }
                }
            ...
            case "UseSingleShadow":
                try {
                    for (var _48 = __values(fromEnum(this.aaf)), _49 = _48.next(); !_49.done; _49 = _48.next()) {
                        var q = _49.value;
                        q.hi();
                    }
                }
            ...
            case "ShadowOffsetX":
                try {
                    for (var _50 = __values(fromEnum(this.aaf)), _51 = _50.next(); !_51.done; _51 = _50.next()) {
                        var r = _51.value;
                        r.g5();
                    }
                }
            ...
            case "ShadowOffsetY":
                try {
                    for (var _52 = __values(fromEnum(this.aaf)), _53 = _52.next(); !_53.done; _53 = _52.next()) {
                        var s = _53.value;
                        s.g6();
                    }
                }
            ...
            case "IsHitTestVisible":
                try {
                    for (var _54 = __values(fromEnum(this.aaf)), _55 = _54.next(); !_55.done; _55 = _54.next()) {
                        var t = _55.value;
                        t.gd();
                    }
                }
            ...
            case "LegendItemBadgeTemplate":
                try {
                    for (var _56 = __values(fromEnum(this.aaf)), _57 = _56.next(); !_57.done; _57 = _56.next()) {
                        var u = _57.value;
                        u.gj();
                    }
                }
            ...
            case "LegendItemTemplate":
                try {
                    for (var _58 = __values(fromEnum(this.aaf)), _59 = _58.next(); !_59.done; _59 = _58.next()) {
                        var v = _59.value;
                        v.gk();
                    }
                }
            ...
            case "LegendItemVisibility":
                try {
                    for (var _60 = __values(fromEnum(this.aaf)), _61 = _60.next(); !_61.done; _61 = _60.next()) {
                        var w = _61.value;
                        w.gl();
                    }
                }
            ...
            case "LegendItemBadgeShape":
                try {
                    for (var _62 = __values(fromEnum(this.aaf)), _63 = _62.next(); !_63.done; _63 = _62.next()) {
                        var x = _63.value;
                        x.gi();
                    }
                }
            ...
            case "LegendItemBadgeMode":
                try {
                    for (var _64 = __values(fromEnum(this.aaf)), _65 = _64.next(); !_65.done; _65 = _64.next()) {
                        var y = _65.value;
                        y.gh();
                    }
                }
            ...
            case "MarkerTemplate":
                try {
                    for (var _66 = __values(fromEnum(this.aaf)), _67 = _66.next(); !_67.done; _67 = _66.next()) {
                        var z = _67.value;
                        z.gu();
                    }
                }
            ...
            case "MarkerType":
                try {
                    for (var _68 = __values(fromEnum(this.aaf)), _69 = _68.next(); !_69.done; _69 = _68.next()) {
                        var aa = _69.value;
                        aa.gw();
                    }
                }
            ...
            case "MarkerThickness":
                try {
                    for (var _70 = __values(fromEnum(this.aaf)), _71 = _70.next(); !_71.done; _71 = _70.next()) {
                        var ab = _71.value;
                        ab.gv();
                    }
                }
            ...
            case "MarkerBrush":
                try {
                    for (var _72 = __values(fromEnum(this.aaf)), _73 = _72.next(); !_73.done; _73 = _72.next()) {
                        var ac = _73.value;
                        ac.go();
                    }
                }
            ...
            case "MarkerOutline":
                try {
                    for (var _74 = __values(fromEnum(this.aaf)), _75 = _74.next(); !_75.done; _75 = _74.next()) {
                        var ad = _75.value;
                        ad.gr();
                    }
                }
            ...
            case "MarkerOutlineMode":
                try {
                    for (var _76 = __values(fromEnum(this.aaf)), _77 = _76.next(); !_77.done; _77 = _76.next()) {
                        var ae = _77.value;
                        ae.gs();
                    }
                }
            ...
            case "MarkerFillMode":
                try {
                    for (var _78 = __values(fromEnum(this.aaf)), _79 = _78.next(); !_79.done; _79 = _78.next()) {
                        var af = _79.value;
                        af.gp();
                    }
                }
            ...
            case "MarkerStyle":
                try {
                    for (var _80 = __values(fromEnum(this.aaf)), _81 = _80.next(); !_81.done; _81 = _80.next()) {
                        var ag = _81.value;
                        ag.gt();
                    }
                }
            ...
            case "Opacity":
                try {
                    for (var _82 = __values(fromEnum(this.aaf)), _83 = _82.next(); !_83.done; _83 = _82.next()) {
                        var ah = _83.value;
                        ah.gx();
                    }
                }
            ...
            case "OpacityMask":
                try {
                    for (var _84 = __values(fromEnum(this.aaf)), _85 = _84.next(); !_85.done; _85 = _84.next()) {
                        var ai = _85.value;
                        ai.gy();
                    }
                }
            ...
            case "AreaFillOpacity":
                try {
                    for (var _86 = __values(fromEnum(this.aaf)), _87 = _86.next(); !_87.done; _87 = _86.next()) {
                        var aj = _87.value;
                        aj.f3();
                    }
                }
            ...
            case "Outline":
                try {
                    for (var _88 = __values(fromEnum(this.aaf)), _89 = _88.next(); !_89.done; _89 = _88.next()) {
                        var ak = _89.value;
                        ak.gz();
                    }
                }
            ...
            case "LineCap":
                try {
                    for (var _90 = __values(fromEnum(this.aaf)), _91 = _90.next(); !_91.done; _91 = _90.next()) {
                        var al = _91.value;
                        al.gm();
                    }
                }
            ...
            case "OutlineMode":
                try {
                    for (var _92 = __values(fromEnum(this.aaf)), _93 = _92.next(); !_93.done; _93 = _92.next()) {
                        var am = _93.value;
                        am.g0();
                    }
                }
            ...
            case "MarkerFillOpacity":
                try {
                    for (var _94 = __values(fromEnum(this.aaf)), _95 = _94.next(); !_95.done; _95 = _94.next()) {
                        var an = _95.value;
                        an.gq();
                    }
                }
            ...
            case "Thickness":
                try {
                    for (var _96 = __values(fromEnum(this.aaf)), _97 = _96.next(); !_97.done; _97 = _96.next()) {
                        var ao = _97.value;
                        ao.g7();
                    }
                }
            ...
            case "LineJoin":
                try {
                    for (var _98 = __values(fromEnum(this.aaf)), _99 = _98.next(); !_99.done; _99 = _98.next()) {
                        var ap = _99.value;
                        ap.gn();
                    }
                }
            ...
            case "ToolTip":
                try {
                    for (var _100 = __values(fromEnum(this.aaf)), _101 = _100.next(); !_101.done; _101 = _100.next()) {
                        var aq = _101.value;
                        aq.g9();
                    }
                }
            ...
            case "TransitionEasingFunction":
                try {
                    for (var _102 = __values(fromEnum(this.aaf)), _103 = _102.next(); !_103.done; _103 = _102.next()) {
                        var ar = _103.value;
                        ar.hb();
                    }
                }
            ...
            case "TransitionDuration":
                try {
                    for (var _104 = __values(fromEnum(this.aaf)), _105 = _104.next(); !_105.done; _105 = _104.next()) {
                        var as = _105.value;
                        as.ha();
                    }
                }
            ...
            case "IsTransitionInEnabled":
                try {
                    for (var _106 = __values(fromEnum(this.aaf)), _107 = _106.next(); !_107.done; _107 = _106.next()) {
                        var at = _107.value;
                        at.gf();
                    }
                }
            ...
            case "TransitionInMode":
                try {
                    for (var _108 = __values(fromEnum(this.aaf)), _109 = _108.next(); !_109.done; _109 = _108.next()) {
                        var au = _109.value;
                        au.he();
                    }
                }
            ...
            case "TransitionInDuration":
                try {
                    for (var _110 = __values(fromEnum(this.aaf)), _111 = _110.next(); !_111.done; _111 = _110.next()) {
                        var av = _111.value;
                        av.gf();
                    }
                }
            ...
            case "TransitionInSpeedType":
                try {
                    for (var _112 = __values(fromEnum(this.aaf)), _113 = _112.next(); !_113.done; _113 = _112.next()) {
                        var aw = _113.value;
                        aw.gf();
                    }
                }
            ...
            case "TransitionInEasingFunction":
                try {
                    for (var _114 = __values(fromEnum(this.aaf)), _115 = _114.next(); !_115.done; _115 = _114.next()) {
                        var ax = _115.value;
                        ax.hd();
                    }
                }
            ...
            case "UseLightweightMarkers":
                try {
                    for (var _116 = __values(fromEnum(this.aaf)), _117 = _116.next(); !_117.done; _117 = _116.next()) {
                        var ay = _117.value;
                        ay.hh();
                    }
                }
            ...
            case "UseHighMarkerFidelity":
                try {
                    for (var _118 = __values(fromEnum(this.aaf)), _119 = _118.next(); !_119.done; _119 = _118.next()) {
                        var az = _119.value;
                        az.hg();
                    }
                }
    ...
    StackedSeriesBase.prototype.gl = function () {
        return false;
    };
    StackedSeriesBase.prototype.get_e3 = function () {
        return false;
    };
    StackedSeriesBase.prototype.rp = function (a, b) {
        var e_59, _a;
        var c = this.gy;
        _super.prototype.rp.call(this, a, b);
        if (!c) {
    ...
    StackedSeriesBase.prototype.rm = function (a, b, c, d, e) {
        var e_60, _a;
    ...
    StackedSeriesBase.prototype.kk = function () {
        var e_61, _a, e_62, _b;
        var a = this.bb.exportStackedVisualData(this, this.wl);
        try {
            for (var _c = __values(fromEnum(this.series)), _d = _c.next(); !_d.done; _d = _c.next()) {
                var b = _d.value;
                var c = this.bb.createFragmentVisualData(this, this.wl, getInstanceType(b).typeName, b.e0);
                ...
                try {
                    for (var _e = (e_62 = void 0, __values(fromEnum(b.visualSeriesLink.actualLayers))), _f = _e.next(); !_f.done; _f = _e.next()) {
                        var d = _f.value;
                        var e = this.bb.createFragmentVisualData(this, this.wl, getInstanceType(d.target).typeName, d.target.name);
                        d.target.ct.an(e);
...
var HorizontalStackedSeriesBase = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    HorizontalStackedSeriesBase.prototype.get_ei = function () {
        return true;
    };
    HorizontalStackedSeriesBase.prototype.get_f3 = function () {
        return this.y0() != null && this.y0().ch;
    };
    HorizontalStackedSeriesBase.prototype.ci = function () {
        return 1;
    };
    HorizontalStackedSeriesBase.prototype.cj = function () {
    ...
    HorizontalStackedSeriesBase.prototype.zg = function () {
        return this.yAxis != null && this.yAxis.c1();
    };
    HorizontalStackedSeriesBase.prototype.r7 = function () {
        var e_63, _a;
        var a = (typeCast(XamDataChart.$, this.c9));
        if (a != null) {
    ...
    HorizontalStackedSeriesBase.prototype.q5 = function (a, b, c, d) {
        _super.prototype.q5.call(this, a, b, c, d);
        switch (b) {
            case "Resolution":
                this.aak.j();
    ...
    HorizontalStackedSeriesBase.prototype.abf = function (a) {
        if (typeCast(NumericYAxis.$, a) !== null) {
            return true;
        }
        return false;
    };
    HorizontalStackedSeriesBase.prototype.abe = function (a) {
...
var StackedAreaSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    StackedAreaSeries.prototype.bi = function () {
        return new StackedAreaSeries();
    };
    StackedAreaSeries.prototype.get_es = function () {
        return true;
    };
    ...
    StackedAreaSeries.prototype.cq = function () {
        return new StackedAreaSeriesView(this);
    };
    StackedAreaSeries.prototype.qx = function (a) {
        _super.prototype.qx.call(this, a);
        this.abk = a;
    };
    StackedAreaSeries.prototype.ax = function (a) {
...
var VerticalStackedSeriesBase = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    VerticalStackedSeriesBase.prototype.yk = function () {
        return this.yAxis;
    };
    VerticalStackedSeriesBase.prototype.y0 = function () {
        return this.xAxis;
    };
    VerticalStackedSeriesBase.prototype.ci = function () {
        if (this.xAxis != null && this.xAxis.ch) {
            return 4;
        }
        return 3;
    };
    VerticalStackedSeriesBase.prototype.cj = function () {
        return 1;
    };
    VerticalStackedSeriesBase.prototype.ay = function (a) {
        if (a.isEmpty && this.c9 != null) {
            a = this.c9.vl;
        }
        var b = this.yk();
    ...
    VerticalStackedSeriesBase.prototype.zg = function () {
        return this.xAxis != null && this.xAxis.c1();
    };
    VerticalStackedSeriesBase.prototype.q5 = function (a, b, c, d) {
        _super.prototype.q5.call(this, a, b, c, d);
        switch (b) {
    ...
    VerticalStackedSeriesBase.prototype.abf = function (a) {
        if (typeCast(CategoryYAxis.$, a) !== null) {
            return true;
        }
        return false;
    };
    VerticalStackedSeriesBase.prototype.abe = function (a) {
...
var StackedBarSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    StackedBarSeries.prototype.bi = function () {
        return new StackedBarSeries();
    };
    StackedBarSeries.prototype.get_ev = function () {
        return true;
    };
    StackedBarSeries.prototype.get_fj = function () {
        return true;
    };
    StackedBarSeries.prototype.ji = function () {
        if (!isNaN_(this.jh)) {
            return _super.prototype.ji.call(this);
        }
        return Defaults.h;
    ...
    StackedBarSeries.prototype.cq = function () {
        return new StackedBarSeriesView(this);
    };
    StackedBarSeries.prototype.qx = function (a) {
        _super.prototype.qx.call(this, a);
        this.abk = a;
    };
    StackedBarSeries.prototype.aae = function () {
        return this.abk;
    };
    StackedBarSeries.prototype.preferredCategoryMode = function (a) {
        return 2;
    };
    StackedBarSeries.prototype.zp = function () {
        var e_64, _a;
        var a = 0;
        try {
    ...
    StackedBarSeries.prototype.aar = function () {
        var a = 0;
        var b = this.c9 != null ? this.c9.vl : Rect.empty;
        var c = this.ct.bx;
    ...
    StackedBarSeries.prototype.aas = function () {
        if (this.xAxis != null) {
            return this.xAxis.l8;
        }
        return 0;
    };
    StackedBarSeries.prototype.ax = function (a) {
        if (this.itemsSource == null) {
            return null;
        }
        if (a == this.yAxis) {
    ...
    StackedBarSeries.prototype.gb = function (a) {
        var b = this.dl != null ? this.dl.indexOf(a) : -1;
        var c = this.c9 != null ? this.c9.vl : Rect.empty;
        c = c.copy();
        var d = this.ct.bx;
        ...
        if (b >= 0 && Rect.l_op_Inequality(c, null) && Rect.l_op_Inequality(d, null)) {
            ...
            if (this.xAxis != null && this.aab != null && b < this.aab.length) {
                var j = this.xAxis.ek(this.aab[b], g);
                var k = this.xAxis.ek(this.aac[b], g);
    ...
    StackedBarSeries.prototype.hc = function (a, b, c) {
        var d = true;
        var e = c;
    ...
    StackedBarSeries.prototype.o9 = function (a, b, c, d) {
        switch (a) {
            case 4:
            case 1:
            case 0:
    ...
    StackedBarSeries.prototype.j1 = function (a) {
        var b = this.c9 != null ? this.c9.vl : Rect.empty;
        var c = this.ct.bx;
        var d = this.getEffectiveViewport1(this.ct);
        var e = -1;
        if (this.yAxis != null && !b.isEmpty && !c.isEmpty) {
            ...
            var g = this.wd(this.ct);
            var h = this.yAxis.en(g.top, f);
            var i = this.yAxis.en(g.bottom, f);
            var j = (a.y - b.top) / b.height;
            var k = h + (j * (i - h));
    ...
    StackedBarSeries.prototype.kl = function (a) {
        var b = this.j1(a);
        return b >= 0 && this.dl != null && b < this.dl.count ? this.dl.item(b) : null;
    };
    StackedBarSeries.prototype.aa7 = function () {
        if (this.xAxis != null) {
            this.xAxis.c2(true);
        }
        if (this.yAxis != null) {
    ...
    StackedBarSeries.prototype.aav = function (a) {
        return this.j1(a);
    };
    StackedBarSeries.prototype.aap = function (a, b, c, d) {
        var e = true;
    ...
    StackedBarSeries.prototype.iu = function () {
        return this.yAxis.k5(this.ct.by, this.ct.bx, this.getEffectiveViewport1(this.ct));
    };
    StackedBarSeries.prototype.aa4 = function (a, b, c, d) {
        var e_65, _a;
        ...
        var g = this.yAxis.k5(c.by, c.bx, this.getEffectiveViewport1(c));
        ...
        var o = b.f;
        var p = e.yk();
        var q = new ScalerParams(0, j, k, p.ch, l);
        var r = 0;
        try {
    ...
    StackedBarSeries.prototype.q5 = function (a, b, c, d) {
        var e_66, _a;
        _super.prototype.q5.call(this, a, b, c, d);
        switch (b) {
...
var StackedColumnSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    StackedColumnSeries.prototype.bi = function () {
        return new StackedColumnSeries();
    };
    StackedColumnSeries.prototype.get_ex = function () {
        return true;
    };
    StackedColumnSeries.prototype.get_fj = function () {
        return true;
    };
    StackedColumnSeries.prototype.ji = function () {
        if (!isNaN_(this.jh)) {
            return _super.prototype.ji.call(this);
        }
        return Defaults.h;
    };
    StackedColumnSeries.prototype.cq = function () {
        return new StackedColumnSeriesView(this);
    };
    StackedColumnSeries.prototype.qx = function (a) {
        _super.prototype.qx.call(this, a);
        this.abk = a;
    };
    StackedColumnSeries.prototype.aae = function () {
        return this.abk;
    };
    StackedColumnSeries.prototype.preferredCategoryMode = function (a) {
        return 2;
    };
    StackedColumnSeries.prototype.ax = function (a) {
        if (this.itemsSource == null) {
            return null;
        }
        if (a == this.xAxis) {
    ...
    StackedColumnSeries.prototype.iu = function () {
        var a = this.getEffectiveViewport1(this.ct);
        return this.xAxis.k5(this.ct.by, this.ct.bx, a);
    };
    StackedColumnSeries.prototype.aa4 = function (a, b, c, d) {
        var e_67, _a;
        ...
        var h = this.xAxis.k5(c.by, c.bx, g);
        ...
        var s = typeCast(ISortingAxis_$type, this.xAxis) !== null;
        var t = 0;
        try {
            for (var _b = __values(fromEnum(b.f)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var u = _c.value;
    ...
    StackedColumnSeries.prototype.q5 = function (a, b, c, d) {
        var e_68, _a;
        _super.prototype.q5.call(this, a, b, c, d);
        switch (b) {
...
var StackedSplineAreaSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    StackedSplineAreaSeries.prototype.bi = function () {
        return new StackedSplineAreaSeries();
    };
    StackedSplineAreaSeries.prototype.ji = function () {
        if (!isNaN_(this.jh)) {
            return _super.prototype.ji.call(this);
        }
        return this.abk.da();
    };
    StackedSplineAreaSeries.prototype.get_es = function () {
        return true;
    };
    StackedSplineAreaSeries.prototype.get_fy = function () {
        return true;
    };
    ...
    StackedSplineAreaSeries.prototype.cq = function () {
        return new StackedSplineAreaSeriesView(this);
    };
    StackedSplineAreaSeries.prototype.qx = function (a) {
        _super.prototype.qx.call(this, a);
        this.abk = a;
    };
    StackedSplineAreaSeries.prototype.ax = function (a) {
        if (this.itemsSource == null) {
            return null;
        }
        if (a == this.xAxis) {
    ...
    StackedSplineAreaSeries.prototype.q5 = function (a, b, c, d) {
        var e_69, _a;
        _super.prototype.q5.call(this, a, b, c, d);
        switch (b) {
...
var StackedSplineSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    StackedSplineSeries.prototype.bi = function () {
        return new StackedSplineSeries();
    };
    StackedSplineSeries.prototype.get_fy = function () {
        return true;
    };
    StackedSplineSeries.prototype.ji = function () {
        if (!isNaN_(this.jh)) {
            return _super.prototype.ji.call(this);
        }
        return this.abk.da();
    ...
    StackedSplineSeries.prototype.cq = function () {
        return new StackedSplineSeriesView(this);
    };
    StackedSplineSeries.prototype.qx = function (a) {
        _super.prototype.qx.call(this, a);
        this.abk = a;
    };
    StackedSplineSeries.prototype.ax = function (a) {
        if (this.itemsSource == null) {
            return null;
        }
        if (a == this.xAxis) {
...
var StackedFragmentSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    StackedFragmentSeries.prototype.gw = function () {
        ...
        var b = a ? this.parentSeries.w0 : this.x;
        if (b == 2 || b == 0) {
            b = 1;
        }
        this.w = b;
...
var StackedSeriesFramePreparer = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    StackedSeriesFramePreparer.prototype.t = function (a, b, c, d, e) {
        ...
        var q = a.p;
        var r = a.o;
        var s = typeCast(NumericAxisBase.$, a.c) !== null && a.c.lk;
...
var StackedSeriesView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    StackedSeriesView.prototype.ar = function () {
        ...
        for (var a = 0; a < this.c5.aak.f.count; a++) {
...
var StackedSeriesManager = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function StackedSeriesManager(a) {
        ...
        _this.k = _this.b.aal.c7;
        _this.l = _this.b.aal.c9;
        var b = _this.c;
