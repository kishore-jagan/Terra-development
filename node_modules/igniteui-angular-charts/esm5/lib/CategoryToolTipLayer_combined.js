...
var CategoryToolTipLayer = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CategoryToolTipLayer.prototype.bi = function () {
        return new CategoryToolTipLayer();
    };
    CategoryToolTipLayer.prototype.get_ep = function () {
        return true;
    };
    CategoryToolTipLayer.prototype.cq = function () {
        return new CategoryToolTipLayerView(this);
    };
    CategoryToolTipLayer.prototype.qx = function (a) {
        _super.prototype.qx.call(this, a);
        this.zr = a;
    };
    CategoryToolTipLayer.prototype.get_e0 = function () {
        return true;
    };
    CategoryToolTipLayer.prototype.q5 = function (a, b, c, d) {
    ...
    CategoryToolTipLayer.prototype.yg = function (a, b) {
        if (this.zp == a) {
            if (!this.a0.c) {
                this.rn(b);
            }
    ...
    CategoryToolTipLayer.prototype.yh = function (a, b) {
        if (!this.a0.c) {
            this.rn(b);
        }
    };
    CategoryToolTipLayer.prototype.yj = function (a, b) {
        var e_1, _a, e_2, _b;
        ...
        if (this.zp != null) {
            ...
            var f = e;
            var g = this.zs(f.de, d);
            this.zy(g, c, d);
        }
        else {
            if (typeCast(XamDataChart.$, this.c9) !== null) {
                var h = this.c9;
                var i = true;
                var j = false;
                ...
                try {
                    for (var _c = __values(fromEnum(h.axes)), _d = _c.next(); !_d.done; _d = _c.next()) {
                        ...
                        if (l.cb && !l.b9) {
                            ...
                            try {
                                for (var _e = (e_2 = void 0, __values(fromEnum(l.de))), _f = _e.next(); !_f.done; _f = _e.next()) {
                                    var m = _f.value;
                                    k.add(m);
                                }
                            }
    ...
    CategoryToolTipLayer.prototype.zs = function (a, b) {
    ...
    CategoryToolTipLayer.prototype.p2 = function () {
        this.zm = { $type: Point_$type, x: NaN, y: NaN };
        this.ct.ar();
    };
    CategoryToolTipLayer.prototype.zy = function (a, b, c) {
        var d = a.c;
        var e = a.a;
        var f = a.b;
        d = this.zr.cj(d);
    ...
    CategoryToolTipLayer.prototype.zu = function (a) {
        return a.toolTip;
    };
    CategoryToolTipLayer.prototype.ym = function (a, b) {
        ...
        var l = c.h;
        if (h != null) {
            this.zr.ch(h, i, j, k, l);
        }
    };
    CategoryToolTipLayer.prototype.f8 = function () {
        return true;
    };
    CategoryToolTipLayer.$t = markType(CategoryToolTipLayer, 'CategoryToolTipLayer', AnnotationLayer.$);
    CategoryToolTipLayer.$$p = markDep(DependencyProperty, PropertyMetadata, CategoryToolTipLayer, 'raisePropertyChanged', ['TargetAxis:zp:zz', [Axis.$, null], 'ToolTipPosition:zq:z0', [CategoryTooltipLayerPosition_$type, enumGetBox(CategoryTooltipLayerPosition_$type, 0)], 'UseInterpolation:zt:z1', [0, false]]);
...
var CategoryToolTipLayerView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CategoryToolTipLayerView.prototype.cd = function () {
        if (this.b8 == null) {
            ...
            this.b8.bw(this.e.jx);
            this.b8.ap = this.e.c9.c8.k;
            this._tooltips = this.e.jx.createElement("div");
            this.cb = this.e.jx.createElement("div");
    ...
    CategoryToolTipLayerView.prototype.ca = function (a, b, c) {
        if (a.k0 == "default") {
            a.k0 = a.ct.getDefaultTooltipTemplate();
        }
        var template_ = a.k0;
        var context_ = c;
        if (a.toolTip == null) {
    ...
    CategoryToolTipLayerView.prototype.an = function (a) {
        ...
        this.e.bb.addPointerTooltipData(a, f, g, h, i);
    };
