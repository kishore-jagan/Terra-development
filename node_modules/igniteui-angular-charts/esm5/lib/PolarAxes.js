...
var PolarAxes = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    PolarAxes.prototype.e = function (a, b, c, d, e, f, g, h, i) {
        ...
        var o;
        var p;
        var q = Math.min(this.a.ly, this.a.lx);
        var r = Math.max(this.a.ly, this.a.lx);
        var s = Math.min(this.b.lx, this.b.ly);
        var t = Math.max(this.b.lx, this.b.ly);
        var u = this.a.lk;
        var v = this.a.ch;
        var w = this.b.lk;
        var x = this.b.ch;
