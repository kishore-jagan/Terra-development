...
var SeriesVisualData = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(SeriesVisualData, _super);
    function SeriesVisualData() {
        ...
        _this.layers = new SeriesVisualDataList();
        return _this;
    }
    ...
    Object.defineProperty(SeriesVisualData.prototype, "layers", {
        get: function () {
            return this._layers;
        },
        set: function (a) {
    ...
    SeriesVisualData.prototype.n = function () {
        var e_1, _a, e_2, _b, e_3, _c, e_4, _d, e_5, _e;
        try {
            for (var _f = __values(fromEnum(this.shapes)), _g = _f.next(); !_g.done; _g = _f.next()) {
                var a = _g.value;
        ...
        try {
            for (var _h = __values(fromEnum(this.markerShapes)), _j = _h.next(); !_j.done; _j = _h.next()) {
                var b = _j.value;
                b.i(this.viewport);
            }
        }
        ...
        try {
            for (var _k = __values(fromEnum(this.pointerTooltips)), _l = _k.next(); !_l.done; _l = _k.next()) {
                var c = _l.value;
        ...
        try {
            for (var _m = __values(fromEnum(this.calloutShapes)), _o = _m.next(); !_o.done; _o = _m.next()) {
                var d = _o.value;
        ...
        try {
            for (var _p = __values(fromEnum(this.layers)), _q = _p.next(); !_q.done; _q = _p.next()) {
                var e = _q.value;
                e.n();
            }
        }
    ...
    SeriesVisualData.prototype.serialize = function () {
        ...
        a.u("],");
        a.u("layers: [");
        for (var f = 0; f < this.layers.count; f++) {
            if (f != 0) {
                a.l(", ");
            }
        ...
        if (this.pixels != null) {
            a.u(", pixels: [");
            for (var g = 0; g < this.pixels.length; g++) {
                if (g != 0) {
                    a.l(", ");
                }
    ...
    SeriesVisualData.prototype.o = function (a) {
    };
...
var SeriesVisualDataList = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(SeriesVisualDataList, _super);
