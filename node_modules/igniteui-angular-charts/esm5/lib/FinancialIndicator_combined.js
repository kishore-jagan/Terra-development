...
var FinancialIndicator = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function FinancialIndicator() {
        ...
        _this.aas = new AxisRange(-100, 100);
        return _this;
    }
    FinancialIndicator.prototype.get_e5 = function () {
        return true;
    };
    FinancialIndicator.prototype.cq = function () {
        return new FinancialIndicatorView(this);
    };
    FinancialIndicator.prototype.qx = function (a) {
        _super.prototype.qx.call(this, a);
        this.aat = a;
    };
    FinancialIndicator.prototype.aa6 = function (a) {
        if (this.xh != null && !this.xh.c1()) {
            this.rn(true);
        }
    };
    FinancialIndicator.prototype.aay = function (a, b, c) {
    ...
    FinancialIndicator.prototype.b0 = function () {
        if (this.b1 == 0) {
            return 1;
        }
        else {
    ...
    FinancialIndicator.prototype.wh = function (a) {
        ...
        var f = new ScalerParams(0, c, d, this.xh.ch, e);
        f.b = this.iw();
    ...
    FinancialIndicator.prototype.gu = function (a, b) {
    ...
    FinancialIndicator.prototype.get_aau = function () {
        return 0;
    };
    Object.defineProperty(FinancialIndicator.prototype, "aau", {
        get: function () {
            return this.get_aau();
        },
        enumerable: false,
    ...
    Object.defineProperty(FinancialIndicator.prototype, "abj", {
        get: function () {
    ...
    FinancialIndicator.prototype.aa3 = function () {
        return -1;
    };
    ...
    FinancialIndicator.prototype.q5 = function (a, b, c, d) {
        switch (b) {
            case "XAxis":
                this.aat.cg();
                break;
        ...
        if (this.aat.ca && this.aat.b8.g$b(a, b, c, d)) {
            this.rn(false);
            var f = typeCast(FinancialIndicatorView.$, this.cs);
            if (f != null && f.ca) {
                f.b8.g$b(a, b, c, d);
            }
            this.qh();
        ...
        switch (b) {
            case "FastItemsSource":
                if (this.dl != null) {
                    this.indicatorColumn = new List$1(Number_$type, 2, this.dl.count);
                    var g = new Array(this.dl.count);
                    for (var h = 0; h < this.dl.count; h++) {
                        g[h] = 0;
                    }
            ...
            case "VolumeColumn":
                if (this.dl != null) {
                    if (this.indicatorColumn.count != this.dl.count) {
                        this.indicatorColumn = new List$1(Number_$type, 2, this.dl.count);
                        var i = new Array(this.dl.count);
                        for (var j = 0; j < this.dl.count; j++) {
                            i[j] = 0;
                        }
    ...
    FinancialIndicator.prototype.i3 = function (a, b, c) {
        if (this.indicatorColumn == null) {
            return _super.prototype.i3.call(this, a, b, c);
        }
        var d = this.getEffectiveViewport1(this.ct);
        var e = this.yp(this.ct.by, this.ct.bx, d);
        var f = new ScalerParams(0, this.ct.by, this.ct.bx, this.wy.ch, d);
        f.c = this.c9.v0;
    ...
    FinancialIndicator.prototype.j6 = function (a, b) {
        if (this.indicatorColumn == null) {
            return _super.prototype.j6.call(this, a, b);
        }
        return this.j7(a, b, this.wy, runOn(this, this.yo), this.indicatorColumn);
    };
    FinancialIndicator.prototype.get_hb = function () {
        return true;
    };
    FinancialIndicator.prototype.aax = function (a, b, c) {
        if (c == null) {
            return true;
        }
    ...
    FinancialIndicator.prototype.ax = function (a) {
        if (this.dl == null) {
            return null;
        }
        if (a != null && a == this.xh) {
    ...
    FinancialIndicator.prototype.gb = function (a) {
        ...
        if (b >= 0 && Rect.l_op_Inequality(c, null) && Rect.l_op_Inequality(d, null)) {
            ...
            if (this.xh != null && this.indicatorColumn != null && b < this.indicatorColumn.count) {
                ...
                i.b = this.iw();
                var j = this.xh.ek(this.indicatorColumn._inner[b], i);
    ...
    FinancialIndicator.prototype.hc = function (a, b, c) {
    ...
    FinancialIndicator.prototype.z4 = function (a, b) {
        var _this = this;
        ...
        if (p.ca) {
            p.b8.prepareLineCore(a.q, this.trendLineType, this.indicatorColumn, o, function (q) { return _this.wy.ek(q, h); }, function (q) { return _this.xh.ek(q, i); }, ((function () {
        ...
        var q = this.wy.en(2, h) - this.wy.en(1, h);
    ...
    FinancialIndicator.prototype.o3 = function (a, b) {
    ...
    FinancialIndicator.prototype.w8 = function () {
        switch (this.aav) {
            case 1: return 1;
            case 2: return 1;
            case 0: return 12;
    ...
    FinancialIndicator.prototype.z6 = function (a, b) {
        ...
        if (b.b3(a)) {
            ...
            if (a.f.count > 0) {
                switch (this.aav) {
                    case 0:
                        var k = CategorySeries.yf(a.f, a.f.count - 1, f, b.by, false);
                    ...
                    case 1:
                        ...
                        var l = CategorySeries.yf(a.f, a.f.count - 1, f, b.by, false);
        ...
        this.w7.ag = i;
        if (o) {
            var q = new ScalerParams(0, b.by, b.bx, this.wy.ch, g);
            this.w7.f = false;
        ...
        this.w7.ag = j;
        if (o) {
            var r = new ScalerParams(0, b.by, b.bx, this.wy.ch, g);
            this.w7.f = true;
    ...
    FinancialIndicator.prototype.sb = function () {
    ...
    FinancialIndicator.prototype.aa7 = function () {
        if (this.aat.ca) {
            this.aat.b8.g$i();
        }
    ...
    FinancialIndicator.prototype.bd = function (a) {
    ...
    FinancialIndicator.aa9 = DependencyProperty.i("ActualTrendLineBrush", Brush.$, FinancialIndicator.$, new PropertyMetadata(2, null, function (a, b) { return a.raisePropertyChanged("ActualTrendLineBrush", b.oldValue, b.newValue); }));
