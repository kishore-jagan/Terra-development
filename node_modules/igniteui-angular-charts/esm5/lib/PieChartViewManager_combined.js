...
var PieLabel = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    PieLabel.prototype.ak = function (a) {
        if (a.a.az == 3) {
            ...
            var e = GeometryUtil.q(d, this.ai, this.ah.a2 + a.a.db);
            var f = a.b4.width;
    ...
    PieLabel.prototype.am = function () {
        ...
        var a;
        var b = this.ah.ai.dc;
        var c = GeometryUtil.q(this.ah.b6(), this.ai, this.ah.a2);
        this.ap.an = c.x;
        this.ap.ap = c.y;
        ...
        if (b > 0) {
            var d = GeometryUtil.j(c, a);
            if (b < d) {
                a = GeometryUtil.s(a, c, b);
            }
            else {
                a = c;
            }
    ...
    PieLabel.prototype.an = function () {
        ...
        var f = GeometryUtil.q(a, this.ai, this.ah.a2);
        var g = GeometryUtil.q(a, this.ai, this.ah.a2 + this.ah.ai.db / 2);
        var h;
        var i;
        var j;
        var k = e;
        ...
        if (d > 0) {
            var l = GeometryUtil.j(f, j);
            if (d < l) {
                i = GeometryUtil.s(j, f, d);
                var m = g.x - f.x;
                var n = g.y - f.y;
                g = GeometryUtil.s(g, f, d);
                var o = g.x - f.x;
                var p = g.y - f.y;
                if ((m > 0 && o < 0) || (m < 0 && o > 0) || (n > 0 && p < 0) || (n < 0 && p > 0)) {
                    g = f;
                }
                h = GeometryUtil.s(h, f, d);
                var q = GeometryUtil.j(f, i) / GeometryUtil.j(f, j);
                h.x = f.x + (h.x - f.x) * q;
                h.y = f.y + (h.y - f.y) * q;
            }
            else {
...
var PieChartBase = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    PieChartBase.prototype.ca = function (a, b) {
        ...
        var g = false;
        var h = false;
        var i = GeometryUtil.q(d, e, c.a2);
        var j = GeometryUtil.q(d, f, c.a2);
    ...
    PieChartBase.g8 = function (a) {
        ...
        for (var c = 0; c < a.count; c++) {
            var d = a._inner[c];
            var e = d.ah;
            var f = GeometryUtil.q(e.b7, d.ai, e.a2);
            b[c] = f.y;
        }
    ...
    PieChartBase.prototype.gp = function () {
        ...
        try {
            for (var _b = __values(fromEnum(this.bv)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var a = _c.value;
                if (isNaN_(a) || isInfinity(a) || a <= 0) {
                    continue;
                }
        ...
        for (var b = 0; b < this.bv.count; b++) {
            var c = this.bv.item(b);
            var d = this.a1 == 0 ? c <= 0 : c < 0;
            if (isNaN_(c) || isInfinity(c) || d) {
                continue;
            }
            var e = this.a2 == 1 ? c / this.dj : c;
            var f = this.a2 == 1 ? this.dd / 100 : this.dd;
            var g = c > 0 || (this.dd > 0 && this.a1 != 1);
            if (e <= f && g) {
                this.de = this.de + c;
                this.cn.add(b);
    ...
    PieChartBase.prototype.gr = function () {
        ...
        for (var e = 0; e < a; e++) {
            ...
            this.a7.j(h);
            h.isExploded = this.b1 ? this.explodedSlices.contains(e) : false;
            c = d;
            h.aw = false;
        }
        this.bx.count = a;
    ...
    PieChartBase.prototype.gq = function () {
        ...
        if (this.br == null || this.br.count == 0 || this.az == 0) {
            this.bw.count = 0;
        }
        var a = this.co.count;
        if (this.cn.count > 0) {
        ...
        var _loop_1 = function (c) {
            ...
            if (c == a - 1 && this_1.cn.count > 0) {
                ...
                if (this_1.cb() || this_1.ap != null || this_1.as != null) {
                    var h = ((function () {
                        ...
                        $ret.series = _this;
                        $ret.item = e ? _this.cm : _this.bm.item(_this.co._inner[c]);
                        $ret.percentValue = _this.c9(_this.bx.item(c));
                        $ret.isOthersSlice = e;
                        return $ret;
                    })());
                    if (f != null) {
                ...
                if (this_1.br != null && this_1.br.count >= this_1.co.count) {
                    f = this_1.br.item(this_1.co._inner[c]);
                }
                else {
                    f = null;
                }
                g = (this_1.bs != null && this_1.bs.count > 0) ? this_1.bs.item(this_1.co._inner[c]) : null;
                if (this_1.cb() || this_1.ap != null || this_1.as != null) {
                    var j = ((function () {
                        var $ret = new PieSliceDataContext();
                        $ret.series = _this;
                    ...
                    if ((this_1.ap != null && !e) || (this_1.as != null && e)) {
                        ...
                        formattedLabel_ = this_1.a5(k);
                    }
                    if (null == formattedLabel_ && this_1.br != null && this_1.br.count > 0) {
                        f = this_1.br.item(this_1.co._inner[c]);
                    }
                    else {
                        f = formattedLabel_;
            ...
            if (this_1.br != null && this_1.br.count > 0) {
                var l = this_1.bw.item(c);
                var m = this_1.bx.item(c);
                m.aj = l;
                l.ai = GeometryUtil.m((m.a3 + m.ax) / 2);
                l.ah = m;
                l.aj = ((function () {
            ...
            if (this_1.bs != null && this_1.bs.count > 0) {
                var n = this_1.bx.item(c);
    ...
    PieChartBase.prototype.gz = function () {
        ...
        var a = this.a4.b5();
        this.i9 = new Rect(0, 0, 0, a.width, a.height);
        var b = this.a4.ab();
        ...
        try {
            for (var _b = __values(fromEnum(this.bx.a)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var i = _c.value;
                var j = GeometryUtil.p(a.width, a.height, true, (i.a3 + i.ax) / 2, f * this.c0);
                i.aw = true;
                i.a1 = this.c1;
                i.a0 = this.c1;
                i.a2 = f;
    ...
    PieChartBase.prototype.gx = function () {
        ...
        if (this.bw.a.count == 0 || this.az == 0) {
            this.bw.count = 0;
            return;
        }
        ...
        try {
            for (var _f = __values(fromEnum(this.bw.a)), _g = _f.next(); !_g.done; _g = _f.next()) {
                var g = _g.value;
                var h = g.ah;
                if (h == null) {
                    continue;
                ...
                if (this.az == 1 || this.az == 4) {
                    var l = h.a2 * h.a1 / 100;
                    var m = GeometryUtil.q(i, g.ai, h.a2 - (h.a2 - l) / 2);
                ...
                if (this.az == 2 || this.az == 4) {
                    var o = PieChartBase.c7(i, h.a2, g);
                    var p = GeometryUtil.q(i, g.ai, o);
                ...
                h.au = false;
                var r = GeometryUtil.q(i, g.ai, h.a2 + this.db);
                g.ag = 3;
                g._visibility = 0;
                g.al();
                if (g.ai < 90 && g.ai >= 0) {
    ...
    PieChartBase.c7 = function (a, b, c) {
        var d = c.ai * Math.PI / 180;
        var e = 1;
        var f = GeometryUtil.q({ $type: Point_$type, x: 0, y: 0 }, c.ai, e);
        ...
        var l = j * k;
        var m = l;
        var n = GeometryUtil.i({ $type: Point_$type, x: 0, y: 0 }, f);
        var o = GeometryUtil.i({ $type: Point_$type, x: 0, y: 0 }, i);
        if (o < n) {
            m = -m;
        }
        var p = GeometryUtil.q(a, (d + m) * 180 / Math.PI, b);
    ...
    PieChartBase.prototype.gy = function () {
        ...
        if ((this.br == null || this.br.count == 0) && (this.bs == null || this.bs.count == 0)) {
        ...
        var _loop_2 = function (a) {
            ...
            var c = this_2.dp(a);
            var d = this_2.a4.bu(a);
            var e = this_2.a4.bv(a);
            b.content = ((function () {
                var $ret = new PieSliceDataContext();
                $ret.series = _this;
                $ret.slice = a;
            ...
            var f = b.content;
            if (this_2.cc() || this_2.aq != null || this_2.ar != null) {
                var g = null;
                if (this_2.cc()) {
                    g = this_2.a6(b.content);
                }
        ...
        if (this.legend.isItemwise) {
            var h = this.legend;
            h.createItemwiseLegendItems(this.cl, this);
        }
    };
    PieChartBase.prototype.bl = function () {
        var a = new PieChartVisualData();
        a.viewport = RectData.b(this.i9);
        this.a4.ao(a);
        for (var b = 0; b < this.bx.count; b++) {
            var c = this.bx.item(b).am();
            a.slices.add(c);
            if (this.bx.item(b).isOthersSlice) {
                a.othersSlice = this.bx.item(b).am();
            }
        }
        a.others = this.cm;
        a.name = this.name;
        a.radiusFactor = this.c3;
    ...
    PieChartBase.prototype.bt = function (a) {
        var b = null;
        return this.bm.registerColumn(a, b, false);
    };
        ...
        switch (b) {
            ...
            case PieChartBase.$$p[9]:
                if (typeCast(FastItemsSource.$, c) != null) {
                    var e = c;
                    e.event = delegateRemove(e.event, this.dk);
                    this.b2 = false;
                    c.deregisterColumn(this.bv);
                    c.deregisterColumn(this.br);
                    this.bv = null;
                    this.br = null;
                    ...
                    (typeCast(FastItemsSource.$, c)).deregisterColumn(this.bs);
                    this.bs = null;
                }
                if (typeCast(FastItemsSource.$, d) != null) {
                    var f = d;
                    f.event = delegateCombine(f.event, this.dk);
                    this.b2 = true;
            ...
            case PieChartBase.$$p[0]:
                if (c != null) {
                    var h = c;
                    h.collectionChanged = delegateRemove(h.collectionChanged, this.cu);
                    this.b0 = false;
                }
                if (d != null) {
                    var i = d;
                    i.collectionChanged = delegateCombine(i.collectionChanged, this.cu);
                    this.b0 = true;
                }
                this.gz();
                this.gy();
            ...
            case PieChartBase.$$p[4]:
                if (c != null) {
                    var j = c;
                    j.collectionChanged = delegateRemove(j.collectionChanged, this.cu);
                    this.b3 = false;
                }
                if (d != null) {
                    var k = d;
                    k.collectionChanged = delegateCombine(k.collectionChanged, this.cu);
                    this.b3 = true;
                }
                this.gz();
                this.gy();
            ...
            case "PixelScalingRatio":
                if (isNaN_(DeviceUtils.a(this.df))) {
                    this.c2 = 1;
                }
                else {
                    this.c2 = DeviceUtils.a(this.df);
                }
                break;
            ...
            case PieChartBase.$$p[22]:
                this.bw.c(runOn(this.a4, this.a4.bm));
                this.gx();
                break;
    ...
    PieChartBase.prototype.cs = function () {
        ...
        if (this.cp == null) {
            this.cp = PieChartMockDataGenerator.a();
        }
        return this.cp;
    };
    ...
    PieChartBase.prototype.hb = function () {
        ...
        if (this.bk == 1) {
            if (a != 0) {
                var b_1 = this.bx.a._inner[this.selectedSlices._inner[a - 1]];
            ...
            if (a != 0) {
                ...
                this.selectedItem = this.bx.a._inner[this.selectedSlices._inner[a - 1]].dataContext;
            }
        }
        this.b6 = false;
    };
    ...
    PieChartBase.prototype.bf = function (a, b) {
        return new SliceEventArgs(a, b);
    };
    PieChartBase.prototype.bg = function (a, b, c) {
        var d = new SliceEventArgs(a, b);
        d.position = c;
        return d;
    };
    ...
    PieChartBase.prototype.c9 = function (a) {
        if (a == null || this.bv == null || this.co == null) {
            return NaN;
        }
        if (a.isOthersSlice) {
            return this.de / this.dj * 100;
        }
        else {
    ...
    PieChartBase.prototype.cj = function (a) {
        return PieChartBase.ck(a, this.itemsSource);
    };
    ...
    PieChartBase.prototype.bn = function () {
        return FontUtil.toFontInfo(this.a4.c.n, this.fq);
    };
    ...
    PieChartBase.hp = DependencyProperty.i("InnerExtent", Number_$type, PieChartBase.$, new PropertyMetadata(2, 0, function (a, b) { return a.gu("InnerExtent", b.oldValue, b.newValue); }));
    PieChartBase.h0 = DependencyProperty.i("LabelTemplate", DataTemplate.$, PieChartBase.$, new PropertyMetadata(2, null, function (a, b) { return a.gu("LabelTemplate", b.oldValue, b.newValue); }));
    PieChartBase.io = DependencyProperty.i("SelectedItem", Base.$, PieChartBase.$, new PropertyMetadata(1, function (a, b) {
    ...
    PieChartBase.$$p = markDep(DependencyProperty, PropertyMetadata, PieChartBase, 'gu', ['ActualBrushes:ak:hd', [BrushCollection.$, null], 'ActualItemsSource::he', [IEnumerable_$type, null], 'ActualLabelInnerColor:iy:hf', [Brush.$, null], 'ActualLabelOuterColor:iz:hg', [Brush.$, null], 'ActualOutlines:al:hh', [BrushCollection.$, null], 'AllowSliceExplosion:b8:hi', [0, true], 'AllowSliceSelection:b9:hj', [0, true], 'Brushes:am:hk', [BrushCollection.$, null], 'ExplodedRadius:c5:hl', [1, 0.2], 'FastItemsSource:bm:hm', [FastItemsSource.$], 'FormatLabel:a5:hn', [Delegate_$type], 'FormatLegendLabel:a6:ho', [Delegate_$type], 'IsDragInteractionEnabled:ce:hq', [0, false], 'IsSurfaceInteractionDisabled:cf:hr', [0, false], 'ItemsSource::hs', [IEnumerable_$type, null], 'LabelExtent:db:ht', [1, 10], 'LabelFormat:ef:hu', [2, null], 'LabelFormatSpecifiers:ag:hv', [Array_$type, null], 'LabelInnerColor:i0:hw', [Brush.$, null], 'LabelMemberPath:ej:hx', [2], 'LabelOuterColor:i1:hy', [Brush.$, null], 'LabelsPosition:az:hz', [LabelsPosition_$type, enumGetBox(LabelsPosition_$type, 1)], 'LeaderLineMargin:dc:h1', [1, 6], 'LeaderLineStyle:ja:h2', [Style.$, null], 'LeaderLineType:a0:h3', [LeaderLineType_$type, enumGetBox(LeaderLineType_$type, 0)], 'LeaderLineVisibility:je:h4', [Visibility_$type, enumGetBox(Visibility_$type, 0)], 'LegendEmptyValuesMode:a1:h5', [LegendEmptyValuesMode_$type, enumGetBox(LegendEmptyValuesMode_$type, 0)], 'LegendItemBadgeTemplate::h6', [DataTemplate.$, null], 'LegendItemTemplate::h7', [DataTemplate.$, null], 'LegendLabelFormat:ew:h8', [2, null], 'LegendLabelFormatSpecifiers:ah:h9', [Array_$type, null], 'LegendLabelMemberPath:ez:ia', [2], 'LegendOthersLabelFormat:e1:ib', [2, null], 'LegendOthersLabelFormatSpecifiers:ai:ic', [Array_$type, null], 'Legend::id', [IChartLegend_$type, null], 'OthersCategoryStyle:jb:ie', [Style.$, null], 'OthersCategoryText:e6:ig', [2, null], 'OthersCategoryThreshold:dd:ih', [1, 3], 'OthersCategoryType:a2:ii', [OthersCategoryType_$type, enumGetBox(OthersCategoryType_$type, 1)], 'OthersLabelFormat:fa:ij', [2, null], 'OthersLabelFormatSpecifiers:aj:ik', [Array_$type, null], 'Outlines:an:il', [BrushCollection.$, null], 'RadiusFactor:dg:im', [1, 0.9], 'SelectedStyle:jc:ip', [Style.$, null], 'SelectionMode:bk:iq', [SliceSelectionMode_$type, enumGetBox(SliceSelectionMode_$type, 1)], 'ShouldDisplayMockData:ch:ir', [0, false], 'ShouldUseSkeletonStyleForMockData:ci:is', [0, false], 'StartAngle:di:it', [1, 0], 'SweepDirection:i3:iu', [SweepDirection_$type, enumGetBox(SweepDirection_$type, 1)], 'ToolTip:dr:iv', [4, null], 'ToolTipStyle:jd:iw', [Style.$, null], 'ValueMemberPath:fv:ix', [2, null]]);
    return PieChartBase;
}(Control));
export { PieChartBase };
/**
...
var Slice = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Slice.prototype.az = function () {
        var a = Math.abs(PieChartBase.dh(this.ax - this.a3)) == 360;
        if (a) {
            return this.a2;
        }
        return this.a2;
    ...
    Slice.prototype.cb = function () {
        var a = (this.ai != null && this.ai.b8) ? true : false;
        var b = this.az();
        if (this.isExploded && a && this.ai.dm > 1) {
    ...
    Slice.prototype.b6 = function () {
        if (this.isExploded && this.ai != null && this.ai.b8 && this.ai.dm > 1) {
            if (this.aq) {
                return this.b3;
            }
            return this.b5;
    ...
    Slice.prototype.bk = function () {
        ...
        var k = Math.abs(PieChartBase.dh(this.ax - this.a3)) == 360;
        if (k) {
            this.cc = this.b8;
            if (this.a0 == 0) {
                var l = ((function () {
        ...
        if (ar && this.b8.height > 0 && this.b8.width > 0 && !b.containsRect(aq)) {
            ...
            at.intersect(as);
            var au = GeometryUtil.m((this.a3 + this.ax) / 2);
            ...
            var az = GeometryUtil.p(this.ai.i9.width, this.ai.i9.height, true, au, this.a2 * this.ai.c0 - ay);
    ...
    Slice.prototype.ap = function (a) {
        ...
        var e = c;
        var f = this.b7;
        if (this.isExploded && this.ai.b8 && this.ai.dm > 1) {
            f = this.b5;
            if (this.aq) {
                f = this.b3;
            }
    ...
    Slice.prototype.ca = function (a, b, c, d, e, f, g) {
        ...
        if ((0 > d && 0 < e) || (360 > d && 360 < e) || (e < d)) {
            h.add(GeometryUtil.q(f, 0, g));
        }
        if (90 > d && 90 < e) {
            h.add(GeometryUtil.q(f, 90, g));
        }
        if (180 > d && 180 < e) {
            h.add(GeometryUtil.q(f, 180, g));
        }
        if (270 > d && 270 < e) {
            h.add(GeometryUtil.q(f, 270, g));
        }
...
var PieChartBaseView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    PieChartBaseView.prototype.a6 = function () {
        this.an();
        this.c.y(this.b4.width, this.b4.height);
        var a = this.k == this.j;
        if (this.k != null && this.k.d && !a) {
            if (this.a.c2 != 1) {
                this.k.aa();
                this.k.ab(this.a.c2, this.a.c2);
            }
            if (!this.b1.isEmpty) {
                if (!this.k.e) {
        ...
        this.a7();
        if (!this.b1.isEmpty && this.a.c2 != 1) {
            if (this.k != null && this.k.d && !a) {
                this.k.z();
            }
            if (this.i != null && this.i.d && !a) {
