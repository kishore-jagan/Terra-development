...
var ErrorBarsHelper = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ErrorBarsHelper.prototype.k = function (a, b, c, d, e) {
        ...
        d = Math.abs(Math.round(c.ek(a + l, j) - k));
        e = Math.abs(Math.round(c.ek(a - l, j) - k));
        return {
            p3: d,
            p4: e
        };
    ...
    ErrorBarsHelper.prototype.j = function (a, b, c, d, e) {
        ...
        d = Math.abs(Math.round(c.ek(j + k, i) - a));
        e = Math.abs(Math.round(c.ek(j - k, i) - a));
        return {
            p3: d,
            p4: e
        };
    ...
    ErrorBarsHelper.prototype.f = function (a, b, c, d, e, f) {
        ...
        e = Math.abs(Math.round(c.ek(l + m, k) - a));
        f = Math.abs(Math.round(c.ek(l - m, k) - a));
        return {
            p4: e,
            p5: f
        };
    ...
    ErrorBarsHelper.prototype.h = function (a, b, c, d, e) {
        ...
        var i = new ScalerParams(1, f, g, c.ch);
        var j = c.en(a, i);
        d = Math.abs(Math.round(c.ek(j + b, i) - a));
        e = Math.abs(Math.round(c.ek(j - b, i) - a));
        return {
            p3: d,
            p4: e
        };
