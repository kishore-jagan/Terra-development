...
var AxisAnnotationManager = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    AxisAnnotationManager.prototype.a = function (a, b, c) {
        var d = NaN;
        d = b.value;
        var e = new LabelPosition(a.e5(d));
        if (a.cc) {
            var f = a;
            if (f.categoryMode == 2) {
                var g = a.bi.vl;
        ...
        var j = e.c;
        if (a.cp) {
            if (e.c > a.ke.bottom || e.c < a.ke.top) {
                return c;
            }
        }
        else {
            if (e.c > a.ke.right || e.c < a.ke.left) {
                return c;
            }
        }
        var k = a.bp.item(c);
    ...
    AxisAnnotationManager.prototype.arrangeAnnotations = function (a, b, c, d, e, f, g, h, i, j) {
        for (var k = 0; k < a.bq.count; k++) {
            ...
            if (e) {
                b.z(l, a.bq.item(k), a.dd._inner[m], d._inner[m], g, h, i, j);
                b.ar(l, a.bq.item(k), a.dd._inner[m], d._inner[m], g, h, i, j, f);
            }
            else {
                b.z(l, a.bq.item(k), a.dd._inner[m], d._inner[m], g, h, i, j);
                b.ad(l);
