...
var RangeAreaSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RangeAreaSeries.prototype.bi = function () {
        return new RangeAreaSeries();
    };
    RangeAreaSeries.prototype.cq = function () {
        return new RangeAreaSeriesView(this);
    };
    RangeAreaSeries.prototype.qx = function (a) {
        _super.prototype.qx.call(this, a);
        this.abj = a;
    };
    RangeAreaSeries.prototype.get_et = function () {
        return true;
    };
    RangeAreaSeries.prototype.get_es = function () {
        return true;
    };
    RangeAreaSeries.prototype.abk = function (a, b, c, d) {
    ...
    RangeAreaSeries.prototype.gu = function (a, b) {
        if (this.gt(a, b)) {
            return true;
        }
        if (this.w9(a, b)) {
    ...
    RangeAreaSeries.prototype.o3 = function (a, b) {
        _super.prototype.o3.call(this, a, b);
        var c = b;
        c.c8();
    };
    RangeAreaSeries.prototype.z4 = function (a, b) {
        ...
        if (k) {
            ...
            this.z0(d, -1, this.lowColumn.count, this.xAxis, m, b.q, -1);
        }
        var n = i.dh;
        var o = i.di;
        var p = i.dc;
        this.yt.ad(n, true, false, true, true);
        this.yt.ad(o, true, false, true, true);
        this.yt.ad(p, false, true, false, false);
        if (b.c0(a)) {
            i.c9(a.f.count, d, false);
            b.c3(a);
        }
        i.dc._opacity = this.yt.j * this.h7;
    };
...
var RangeAreaSeriesView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RangeAreaSeriesView.prototype.an = function (a) {
        ...
        this.e.bb.exportPolylineData(a, this.df, "lowerShape", ["Lower"]);
        this.e.bb.exportPolylineData(a, this.dg, "upperShape", ["Upper", "Main"]);
        this.e.bb.exportPolygonData(a, this.db, "fillShape", ["Fill"]);
    };
