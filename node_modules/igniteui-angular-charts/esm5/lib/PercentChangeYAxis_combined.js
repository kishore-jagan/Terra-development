...
var PercentChangeYAxis = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    PercentChangeYAxis.prototype.k4 = function () {
        return new VerticalPercentChangeScaler(this);
    };
    PercentChangeYAxis.prototype.ks = function () {
        var e_1, _a;
    ...
    PercentChangeYAxis.prototype.k0 = function (a) {
        return new PercentChangeAxisRenderer(a);
    };
    PercentChangeYAxis.prototype.d1 = function (a, b) {
        var c = ((a - b.b) / b.b) * 100;
        if (c < this.ly) {
            var d = ((this.ly / 100) * b.b) + b.b;
            return d;
        }
        if (c > this.lx) {
            var e = ((this.lx / 100) * b.b) + b.b;
            return e;
        }
        return a;
    };
