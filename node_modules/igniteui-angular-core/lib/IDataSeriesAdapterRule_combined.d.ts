...
export declare class DataSeriesAdapterImplementation extends Base implements INotifyPropertyChanged {
    ...
    private z;
    private aa;
    ai: (arg1: string) => string;
    ap(a: string, b: string): string;
    private a8;
    private bg;
    ak: any;
    ...
    private ac;
    refresh(): void;
    ay(a: HashSet$1<Tuple$2<string, string>>, b: HashSet$1<Tuple$2<string, string>>): void;
    private bf;
    private au;
    private bk;
    private be;
    ...
    private aw;
    private av;
    bb(a: DataSeriesAdapterRunContext, b: any, c: string, d: boolean): void;
    private at;
    private ba;
    a4(a: IDataSourceLocalDataProvider): void;
    a5(a: IDataSourceLocalDataProvider, b: number, c: any): void;
    a6(a: IDataSourceLocalDataProvider, b: number, c: any): void;
    a7(a: IDataSourceLocalDataProvider, b: number, c: any, d: any): void;
