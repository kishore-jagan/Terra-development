...
var Type = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Type.createInstance = function ($t) {
        ...
        if ($t.InstanceConstructor) {
            ...
            result = new (C.bind.apply(C, __spreadArray([void 0], __read(Array.prototype.slice.call(arguments, 1)))))();
            return result;
        }
    ...
    TypeRegistrar.create = function (typeName) {
        ...
        if (TypeRegistrar.isRegistered(typeName)) {
            ...
            if (C.htmlTagName) {
                ...
                return new (C.bind.apply(C, __spreadArray([void 0], __read(rest))))();
            }
        }
        else {
            return null;
...
export function createMutationObserver() {
    ...
    return new (origObserver.bind.apply(origObserver, __spreadArray([void 0], __read(args))))();
}
