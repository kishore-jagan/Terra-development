...
var ColorUtil = /** @class */ /*@__PURE__*/ (function (_super) {
            ...
            case 1:
                {
                    ...
                    return ColorUtil.r(c[0] + interpolation_ * (d[0] - c[0]), e + interpolation_ * (f - e), c[2] + interpolation_ * (d[2] - c[2]), c[3] + interpolation_ * (d[3] - c[3]));
                }
    ...
    ColorUtil.u = function (a, b, c) {
        ...
        return ColorUtil.r(a[0] + b * (c[0] - a[0]), d + b * (e - d), a[2] + b * (c[2] - a[2]), a[3] + b * (c[3] - a[3]));
    };
    ColorUtil.x = function (a, b) {
        var c = ColorUtil.a(a);
        if (b < 0) {
            return ColorUtil.q(c[0], c[1], c[2], c[3] * (1 - MathUtil.d(-b, 0, 1)));
        }
        else {
            return ColorUtil.q(c[0], c[1], c[2], c[3] + MathUtil.d(b, 0, 1) * (1 - c[3]));
        }
    };
    ColorUtil.y = function (a, b) {
        var c = ColorUtil.a(a);
        if (b < 0) {
            return ColorUtil.q(c[0], c[1], c[2] * (1 - MathUtil.d(-b, 0, 1)), c[3]);
        }
        else {
            return ColorUtil.q(c[0], c[1], MathUtil.d(c[2] + MathUtil.d(b, 0, 1) * (1 - c[2]), 0, 1), c[3]);
        }
    };
    ...
    ColorUtil.ab = function (a, b) {
        var c = a.l / 255;
        var d = (1 - c) * b.o + c * a.o;
        var e = (1 - c) * b.n + c * a.n;
        var f = (1 - c) * b.m + c * a.m;
        return Color.u(255, truncate(Math.round(d)), truncate(Math.round(e)), truncate(Math.round(f)));
    };
    ...
    ColorUtil.s = function (a) {
        var b = ((function () {
            var $ret = new Color();
            $ret.l = 255;
            return $ret;
        })());
        b = ColorUtil.t(a._fill);
        return b;
    };
