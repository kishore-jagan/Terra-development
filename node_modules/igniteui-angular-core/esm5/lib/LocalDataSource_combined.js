...
var LocalDataSource = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function LocalDataSource() {
        ...
        _this.d4 = null;
        _this.c6 = null;
        _this.dl = new List$1(Array_$type, 0);
        _this.db = false;
        _this.cx = null;
        _this.du = -1;
        _this.dm = -1;
    ...
    Object.defineProperty(LocalDataSource.prototype, "c5", {
        get: function () {
            return this.c4;
        },
        set: function (a) {
    ...
    LocalDataSource.prototype.dd = function (a, b) {
        if (a == null && b == null) {
            return true;
        }
        if (a == null || b == null) {
    ...
    LocalDataSource.prototype.d6 = function () {
        this.actualCount = this.c8.a7.count;
        this.onBroadcastClearItems();
    };
    LocalDataSource.prototype.d9 = function (a, b, c) {
        this.actualCount = this.c8.a7.count;
    ...
    LocalDataSource.prototype.d8 = function (a, b) {
        this.actualCount = this.c8.a7.count;
    ...
    LocalDataSource.prototype.unpinRow = function (a) {
        ...
        var b = this.c7();
        if (this.c8 != null) {
            for (var c = this.dl.count - 1; c >= 0; c--) {
                var d = this.dl._inner[c];
            ...
            for (var e = this.dl.count - 1; e >= 0; e--) {
                var f = this.dl._inner[e];
    ...
    LocalDataSource.prototype.clearPinnedRows = function () {
        for (var a = this.dl.count - 1; a >= 0; a--) {
    ...
    LocalDataSource.prototype.getStickyRowsInRange = function (a, b) {
        ...
        for (var h = c.ae; h <= d.ae; h++) {
            var i = this.c8.a6._inner[h];
            var j = this.c8.a6._inner[h].c.length;
            var k = this.c8.a6._inner[h].v();
            if (this.shouldEmitSectionHeaders && this.aq) {
                for (var l = 0; l < j; l++) {
            ...
            if (this.c8.a6._inner[h].p) {
                if (this.shouldEmitShiftedRows) {
                    for (var o = 0; o < this.c8.a6._inner[h].aa; o++) {
            ...
            if (this.summaryScope == 0 || this.summaryScope == 2) {
                if (this.shouldEmitSummaryRows && this.includeSummaryRowsInSection && this.isSectionSummaryRowsAtBottom) {
                    for (var p = this.c8.a6._inner[h].ag - 1; p >= 0; p--) {
        ...
        for (var r = this.c8.a7.count - this.c8.bl; r < this.c8.a7.count; r++) {
            g.add(r);
        }
        this.cx = g.toArray();
        return this.cx;
    ...
    LocalDataSource.prototype.cq = function (a, b) {
        var e_1, _a, e_2, _b;
        if (a == 5) {
            ...
            for (var g = 0; g < f.length; g++) {
                if (f[g].transactionType == 1) {
                    ...
                    if (i != null) {
                        ...
                        if (this.dl.count > 0) {
                            var r = this.c7();
                            for (var s = 0; s < this.dl.count; s++) {
                                if (r.h(this.dl._inner[s], h) == 0) {
                                    var t = this.getStickyRows();
                                    for (var u = 0; u < t.length; u++) {
                                        var v = t[u];
                                        var w = typeCast(DataSourceSpecialRow.$, this.c8.a7.item(v));
