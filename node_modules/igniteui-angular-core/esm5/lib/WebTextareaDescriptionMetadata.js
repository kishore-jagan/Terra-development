...
var WebTextareaDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    WebTextareaDescriptionMetadata.c = function (a) {
        ...
        a.item("Autocapitalize@names", "None;Off;On;Sentences;Words;Characters");
        a.item("InputMode", "ExportedType:string:TextareaInputMode");
        a.item("InputMode@stringUnion", "WebComponents;React");
        a.item("InputMode@names", "None;Email;Search;Tel;Text;Url;Decimal;Numeric");
        a.item("Label", "String");
        ...
        a.item("Resize@names", "None;Vertical;Auto");
        ...
        a.item("Wrap@names", "Off;Hard;Soft");
