...
var DataSeriesAdapterRunContext = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function DataSeriesAdapterRunContext(a) {
        ...
        _this.n = new Stack$1(IDataSourceLocalDataProvider_$type);
        _this.o = new Stack$1(IDataSourceLocalDataProvider_$type);
        _this.q = new Stack$1(String_$type);
        _this.p = new Stack$1(String_$type);
        _this.b = _this.g.includedProperties;
        _this.a = _this.g.excludedProperties;
        _this.m = null;
        if (_this.g.supportedSeriesTypes != null) {
            _this.m = new HashSet$1(DataSeriesType_$type, 0);
            for (var b = 0; b < _this.g.supportedSeriesTypes.length; b++) {
                _this.m.add_1(_this.g.supportedSeriesTypes[b]);
            }
        }
        return _this;
    }
    ...
    DataSeriesAdapterRunContext.prototype.z = function (a, b) {
    ...
    DataSeriesAdapterRunContext.prototype.ae = function (a, b) {
        if (a.priority == -1) {
...
var DataSeriesDataProviderAnalyzer = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function DataSeriesDataProviderAnalyzer(a) {
        ...
        _this.x = false;
        _this.w = false;
        _this.ap = new HashSet$1(String_$type, 0);
        _this.ar = new List$1(Matcher.$, 0);
        _this.ao = new HashSet$1(String_$type, 0);
        _this.aq = new List$1(Matcher.$, 0);
        _this.u = a;
        return _this;
    }
    ...
    DataSeriesDataProviderAnalyzer.prototype.an = function (a, b) {
        if (a == null) {
            return true;
        }
    ...
    DataSeriesDataProviderAnalyzer.prototype.aj = function (a) {
    ...
    DataSeriesDataProviderAnalyzer.prototype.isMonotonic = function (a, b, c) {
        ...
        for (var g = 0; g < Math.min(f, c); g++) {
            ...
            var h = this.as(a.getItemValue(a.getItemAtIndex(g - 1), b));
            var i = this.as(a.getItemValue(a.getItemAtIndex(g), b));
            if (!e && h != i) {
                d = i > h;
                e = true;
            }
    ...
    DataSeriesDataProviderAnalyzer.prototype.a1 = function (a, b, c) {
        var d = this.u.getCurrentDataSource();
        var e = d.actualSchema;
        if (e == null) {
            return null;
    ...
    DataSeriesDataProviderAnalyzer.prototype.getFirstDistinctStringProperty = function (a) {
        return this.a1(a, function (b) { return b == 0; }, runOn(this, this.al));
    };
    ...
    DataSeriesDataProviderAnalyzer.prototype.getFirstDistinctMonotonicNumericProperty = function (a) {
        var _this = this;
        var b = this.u.getCurrentDataSource();
        return this.a1(a, runOn(this, this.aj), function (c, d) { return _this.ai(c, d) && _this.isMonotonic(b, c, a); });
    };
    DataSeriesDataProviderAnalyzer.prototype.getAllDistinctMonotonicNumericProperties = function (a) {
        var _this = this;
        var b = this.u.getCurrentDataSource();
        return this.s(runOn(this, this.aj), function (c) { return _this.ai(c, _this.v(c)) && _this.isMonotonic(b, c, a); });
    };
    DataSeriesDataProviderAnalyzer.prototype.getAllExcludedDistinctMonotonicNumericProperties = function (a) {
        var _this = this;
        var b = this.u.getCurrentDataSource();
        return this.r(runOn(this, this.aj), function (c) { return _this.ai(c, _this.v(c)) && _this.isMonotonic(b, c, a); });
    };
    ...
    DataSeriesDataProviderAnalyzer.prototype.av = function (a, b, c) {
        if (a != null) {
    ...
    DataSeriesDataProviderAnalyzer.prototype.al = function (a, b) {
        var c = this.u.getCurrentDataSource();
    ...
    DataSeriesDataProviderAnalyzer.prototype.as = function (value_) {
        return (+value_);
    };
...
var DataSeriesAdapterImplementation = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function DataSeriesAdapterImplementation() {
        ...
        _this.ag = new Dictionary$2(Base.$, DataSeriesAdapterProviderInfo.$, 0);
        _this.aj = null;
        ...
        _this.t.n(runOn(_this, _this.as));
        _this.r.n(runOn(_this, _this.as));
        _this.x.n(runOn(_this, _this.as));
        _this.m.n(runOn(_this, _this.as));
        _this.n.n(runOn(_this, _this.as));
        _this.s.n(runOn(_this, _this.as));
        _this.rules = new DataSeriesAdapterRuleCollection();
        _this.dataSeries = new DataSeriesCollection();
        _this.a8(_this.rules);
        var a = _this.rules;
        a.collectionChanged = delegateCombine(a.collectionChanged, runOn(_this, _this.bg));
        return _this;
    }
    DataSeriesAdapterImplementation.prototype.as = function (a, b) {
        var c = this.ad;
        var d = this.af();
        var e = this.ae();
    ...
    DataSeriesAdapterImplementation.prototype.bg = function (a, b) {
        this.refresh();
    };
    ...
    DataSeriesAdapterImplementation.prototype.a3 = function (a, b, c) {
        this.a9(a, b, c);
        if (this.propertyChanged != null) {
            this.propertyChanged(this, new PropertyChangedEventArgs(a));
        }
    };
    DataSeriesAdapterImplementation.prototype.a9 = function (a, b, c) {
        switch (a) {
            case "ItemsSource":
                this.refresh();
                break;
    ...
    DataSeriesAdapterImplementation.prototype.ay = function (a, b) {
        ...
        b.clear();
        var k = d.c.actualSchema.propertyNames;
    ...
    DataSeriesAdapterImplementation.prototype.bf = function () {
        var e_2, _a;
        try {
            for (var _b = __values(fromEnum(this.ah.keys)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var a = _c.value;
                var b = this.ah.item(a);
                b.d = false;
            }
        }
        catch (e_2_1) {
    ...
    DataSeriesAdapterImplementation.prototype.au = function () {
        var e_3, _a;
        var a = new List$1(Base.$, 0);
        try {
            for (var _b = __values(fromEnum(this.ah.keys)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var b = _c.value;
                var c = this.ah.item(b);
                if (!c.d) {
                    a.add1(b);
                    this.av(c);
                }
    ...
    DataSeriesAdapterImplementation.prototype.bd = function (a) {
        var e_4, _a;
    ...
    DataSeriesAdapterImplementation.prototype.bi = function (a) {
    ...
    Object.defineProperty(DataSeriesAdapterImplementation.prototype, "ad", {
        get: function () {
    ...
    DataSeriesAdapterImplementation.prototype.ae = function () {
    ...
    DataSeriesAdapterImplementation.prototype.aw = function (a, b, c) {
        this.av(c);
        a.removeItem(b);
    };
    DataSeriesAdapterImplementation.prototype.av = function (a) {
        if (a.e.count > 0) {
    ...
    DataSeriesAdapterImplementation.prototype.bb = function (a, b, c, d) {
    ...
    DataSeriesAdapterImplementation.prototype.at = function (a, b, c, d) {
        if (a != null && !this.ah.containsKey(a)) {
            b.a = 0;
    ...
    DataSeriesAdapterImplementation.prototype.ba = function (a, b) {
        if (!this.ac) {
            this.refresh();
        }
    };
    DataSeriesAdapterImplementation.prototype.a4 = function (a) {
        this.refresh();
    };
    DataSeriesAdapterImplementation.prototype.a5 = function (a, b, c) {
        this.refresh();
    };
    DataSeriesAdapterImplementation.prototype.a6 = function (a, b, c) {
        this.refresh();
    };
    DataSeriesAdapterImplementation.prototype.a7 = function (a, b, c, d) {
        this.refresh();
    };
