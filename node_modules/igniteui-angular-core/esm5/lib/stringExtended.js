...
export function stringFormat(format) {
    ...
    return stringFormat1.apply(void 0, __spreadArray([format], __read(rest)));
}
;
export function stringFormat1(format) {
    ...
    return stringFormat2.apply(void 0, __spreadArray([CultureInfo.currentCulture, format], __read(args)));
}
;
