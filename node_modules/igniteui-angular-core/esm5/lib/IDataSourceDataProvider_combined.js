...
var BaseDataSource = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function BaseDataSource() {
        ...
        _this.t.n(runOn(_this, _this.cv));
        _this.s.n(runOn(_this, _this.bz));
        _this.u.n(runOn(_this, _this.cw));
        ...
        var a = _this.v;
        a.stateChanged = delegateCombine(a.stateChanged, runOn(_this, _this.cr));
        return _this;
    }
    ...
    BaseDataSource.prototype.cv = function (a, b) {
    ...
    BaseDataSource.prototype.ct = function () {
        if (this.actualBaseDataProvider != null) {
