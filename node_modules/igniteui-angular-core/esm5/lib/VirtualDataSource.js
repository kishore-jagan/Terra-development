...
var VirtualDataSource = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function VirtualDataSource() {
        ...
        _this.cz = null;
        _this.c0 = null;
        _this.dg = new LRUCache$2(Base.$, IDataSourcePage_$type, 0, 200);
        _this.dn = new Dictionary$2(Base.$, Array_$type, 0);
        _this.dp = new Dictionary$2(Number_$type, Number_$type, 0);
        _this.di = false;
        _this.cx = null;
        _this.c1 = null;
        _this.df = new SectionMap();
        _this.cy = null;
        _this.dy = -1;
        _this.dr = -1;
        _this.d0 = -1;
        ...
        _this.dv = -1;
        _this.dx = -1;
        _this.dm = new Dictionary$2(String_$type, Boolean_$type, 0);
        _this._concurrencyTag = null;
        _this.batchStarted = null;
        _this.batchCompleted = null;
        _this.dd = new PagePredictionEngine();
        _this.dd.e = _this;
        _this.dd.ag = _this.actualPageSize;
        _this.dd.f = _this.df;
        _this.executionContext = new DataSourceExecutionContext();
        _this.dd.b = _this.executionContext;
    ...
    Object.defineProperty(VirtualDataSource.prototype, "dataProvider", {
        ...
        set: function (a) {
            ...
            this.c4 = a;
            if (b != this.c4) {
                this.onPropertyUpdated("DataProvider", b, this.c4);
            }
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(VirtualDataSource.prototype, "actualDataProvider", {
        ...
        set: function (a) {
            ...
            this.c3 = a;
            if (b != this.c3) {
                this.onPropertyUpdated("ActualDataProvider", b, this.c3);
            }
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(VirtualDataSource.prototype, "pageSizeRequested", {
        ...
        set: function (a) {
            ...
            this.d5 = a;
            if (b != this.d5) {
                this.onPropertyUpdated("PageSizeRequested", b, this.d5);
            }
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(VirtualDataSource.prototype, "maxCachedPages", {
        ...
        set: function (a) {
            ...
            this.d4 = a;
            if (b != this.d4) {
                this.onPropertyUpdated("MaxCachedPages", b, this.d4);
            }
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(VirtualDataSource.prototype, "actualPageSize", {
        ...
        set: function (a) {
            ...
            this.dq = a;
            if (b != this.dq) {
                this.onPropertyUpdated("ActualPageSize", b, this.dq);
            }
        },
        enumerable: false,
        configurable: true
    ...
    VirtualDataSource.prototype.get_isSortingSupported = function () {
        if (this.externalDataSource != null && !this.dh) {
            this.dh = true;
    ...
    Object.defineProperty(VirtualDataSource.prototype, "c9", {
        get: function () {
            return this.c8;
        },
        set: function (a) {
    ...
    VirtualDataSource.prototype.resolveDataProvider = function () {
        ...
        return this.c9.resolveDataProvider();
    };
    VirtualDataSource.prototype.propertyUpdatedOverride = function (a, b, c) {
        ...
        switch (a) {
            ...
            case "ExecutionContext":
                this.dd.b = this.executionContext;
                break;
            case "ActualDataProvider":
                this.actualDataProvider.pageSizeRequested = this.pageSizeRequested;
                this.actualDataProvider.pageLoaded = runOn(this, this.er);
                this.actualDataProvider.batchCompleted = runOn(this, this.eq);
                this.queueAutoRefresh();
                break;
            case "PageSizeRequested":
                ...
                break;
            case "ActualPageSize":
                this.dd.ag = this.actualPageSize;
                this.queueAutoRefresh();
                break;
            case "FirstVisibleIndexRequested":
                this.dd.aa = this.firstVisibleIndexRequested;
                break;
            case "LastVisibleIndexRequested":
                this.dd.ae = this.lastVisibleIndexRequested;
                break;
            case "ActualCount":
                if (this.actualDataProvider != null && !this.df.q) {
                    this.dd.ab = this.actualDataProvider.actualCount;
                }
                else {
                    this.dd.ab = this.actualCount;
                }
                this.queueAutoRefresh();
                break;
            case "MaxCachedPages":
                this.dg.h = this.maxCachedPages;
                break;
        }
    };
    VirtualDataSource.prototype.ea = function (a) {
        if (this.aq && this.df.q) {
            var b = this.de(a);
            if (b == null) {
                b = this.df.d();
            }
    ...
    VirtualDataSource.prototype.er = function (a, b, c) {
        ...
        if (d != null) {
            d.execute(function () { return _this.ex(a, b, c); });
        }
        else {
            this.ex(a, b, c);
        }
    };
    VirtualDataSource.prototype.ex = function (a, b, c) {
        if (a == null) {
        ...
        if (this.summaryDescriptions.k.count > 0 && this.c1 == null && f != null) {
            this.c1 = f;
            for (var g = 0; g < this.c1.length; g++) {
                this.c1[g].summaryIndex = this.d8(this.c1[g]);
            }
            var h = SectionData.r(this.c1);
            this.d6 = h.count;
        }
        var i = a.getGroupInformation();
        if (this.groupDescriptions.k.count > 0 && this.cx == null && i != null) {
            this.cx = i;
            this.ew();
            this.dj = false;
        }
    ...
    VirtualDataSource.prototype.resolveFullCount = function (a) {
        if (this.cx != null) {
            return this.df.u + this.getRootSummaryRowCount();
        }
        return a + this.getRootSummaryRowCount();
    };
    VirtualDataSource.prototype.ew = function () {
        var a = 0;
        var b = 0;
        var c = this.shouldEmitSectionHeaders;
        var d = this.shouldEmitSectionFooters;
        for (var e = 0; e < this.cx.length; e++) {
            var f = new SectionData();
            var g = b;
            var h = this.cx[e].endIndex - this.cx[e].startIndex;
            f.af = a;
            f.ae = e;
            ...
            f.ad = a + h;
            f.t = 0;
            f.e = this.cx[e].groupKeyProperties;
            f.f = this.cx[e].groupKeyValues;
            f.h = new Array(0);
            ...
            if (this.summaryScope == 0 || this.summaryScope == 2) {
                if (this.cx[e].summaryResults != null) {
                    f.i[this.groupDescriptions.k.count - 1] = this.cx[e].summaryResults;
                    if (f.i != null) {
                        for (var k = 0; k < f.i[this.groupDescriptions.k.count - 1].length; k++) {
                            var l = f.i[this.groupDescriptions.k.count - 1][k];
                            l.summaryIndex = this.d8(l);
                            l.groupKey = f.f;
                        }
            ...
            if (c) {
                ...
                for (var p = m; p < f.c.length; p++) {
                    ...
                    f.a[p] = q;
                    f.b[p] = p - m;
                    if (this.dm.containsKey(q)) {
                        f.c[p] = this.dm.item(q);
                    }
                    else {
        ...
        var u = 0;
        for (var v = 0; v < this.df.t.count; v++) {
            var w = this.df.t._inner[v];
    ...
    VirtualDataSource.prototype.ep = function (a, b) {
        if (b) {
            this.cz = new Array(this.groupDescriptions.k.count);
            for (var c = 0; c < this.cz.length; c++) {
                this.cz[c] = a;
            }
        }
        if (this.sectionHeaderDisplayMode == 1) {
            ...
            for (var f = 0; f < e; f++) {
                ...
                var g = false;
                if (this.cz[f].f[f] == null) {
                    g = a.f[f] != null;
                }
                else {
                    g = !Base.equalsStatic(this.cz[f].f[f], a.f[f]);
                }
                if (g) {
                    this.cz[f] = a;
                    if (f - 1 > -1) {
                        var h = f - 1;
                        while (h >= 0 && this.cz[h].o) {
                            h = h - 1;
                        }
                        a.z = this.cz[h].ae;
                    }
            ...
            for (var j = 0; j < a.e.length; j++) {
                if (this.cz[0].f[j] == null) {
                    if (this.cz[0].f[j] != a.f[j]) {
                        i = true;
                        break;
                    }
                    continue;
                }
                if (!Base.equalsStatic(this.cz[0].f[j], a.f[j])) {
                    i = true;
                    break;
                }
            }
    ...
    VirtualDataSource.prototype.c2 = function (a) {
        if (this.aq && this.df.q) {
            var b = false;
            var c = this.de(a);
            if (c == null) {
                c = this.df.d();
                if (this.c1.length > 0 && a > c.ad) {
                    b = true;
                }
            }
            var d = c.af;
    ...
    VirtualDataSource.prototype.de = function (a) {
        return this.df.e(a);
    };
    ...
    VirtualDataSource.prototype.eu = function (a) {
        if (!this.dp.containsKey(a)) {
            ...
            this.dp.item(a, this.dp.item(a) + 1);
        }
    };
    ...
    VirtualDataSource.prototype.removeCandidate = function (a) {
        if (this.dn.containsKey(a)) {
            for (var b = 0; b < this.dn.item(a).length; b++) {
                var c = this.dn.item(a)[b];
                this.es(c);
            }
    ...
    VirtualDataSource.prototype.transformPage = function (a) {
        ...
        if (this.aq && this.df.q) {
            ...
            for (var g = c; g <= d; g++) {
                ...
                if (g > e.ad) {
                    if (e.ae < this.df.t.count - 1) {
                        e = this.df.t._inner[e.ae + 1];
                    }
                    else {
                        break;
                    }
    ...
    VirtualDataSource.prototype.getUnrealizedCount = function () {
        var a = this.dg.g * this.actualPageSize;
    ...
    VirtualDataSource.prototype.ey = function () {
        var e_1, _a;
        if (this.actualDataProvider != null) {
            try {
                for (var _b = __values(fromEnum(this.dn.values)), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var a = _c.value;
    ...
    VirtualDataSource.prototype.indexOfItem = function (a) {
        ...
        for (var g = 0; g < e; g++) {
            ...
            var i = h.count();
            for (var j = 0; j < i; j++) {
                if (this.dl(h.getItemAtIndex(j), a)) {
    ...
    VirtualDataSource.prototype.dl = function (a, b) {
        if (a == null && b == null) {
            return true;
        }
        if (a == null || b == null) {
    ...
    VirtualDataSource.prototype.indexOfKey = function (a) {
        ...
        if (this.aq && this.shouldEmitSectionHeaders && !this.isSectionContentVisible && this.isSectionHeaderNormalRow) {
            if (this.df.t.count > 0) {
                for (var d = 0; d < this.df.t.count; d++) {
                    var e = this.df.t._inner[d];
    ...
    VirtualDataSource.prototype.dc = function () {
    ...
    VirtualDataSource.prototype.getStickyRowsInRange = function (a, b) {
        ...
        var d = this.de(b);
        if (this.df.t.count > 0) {
            if (this.df.t.count == 1) {
                c = this.df.t._inner[0];
                d = this.df.t._inner[0];
            }
            else {
                c = this.df.e(a);
                if (c != null) {
                    while (c.z != -1) {
                        c = this.df.t._inner[c.z];
                    }
                }
                d = this.df.e(b);
        ...
        if (c.ae == this.dy && c.aa == this.d0 && c.af == this.d1 && c.ad == this.dz && c.ah == this.d3 && c.ag == this.d2 && d.ae == this.dr && d.aa == this.dt && d.af == this.du && d.ad == this.ds && d.ah == this.dw && d.ag == this.dv && this.getRootSummaryRowCount() == this.dx) {
            return this.cy;
        }
        this.dy = c.ae;
        this.dr = d.ae;
        ...
        this.d3 = c.ah;
        this.d2 = c.ag;
        this.dx = this.getRootSummaryRowCount();
        var g = new List$1(Number_$type, 0);
        for (var h = c.ae; h <= d.ae; h++) {
            var i = this.df.t._inner[h];
            var j = i.c.length;
            var k = i.v();
        ...
        for (var d = 0; d < c.a.length; d++) {
            if (c.a[d] != null) {
                if (a == c.af + c.b[d]) {
                    var e = false;
                    var f = c.a[d];
                    if (this.dm.containsKey(f) && this.dm.item(f) != b) {
                        var g = this.dm.item(f);
                        if (b == this.isSectionExpandedDefault) {
                            this.dm.removeItem(f);
                        }
                        else {
                            this.dm.item(f, b);
                        }
                    ...
                    if (e) {
                        ...
                        this.ew();
                        this.dj = true;
                        if (this.actualCount != this.df.u) {
                            this.actualCount = this.df.u + this.getRootSummaryRowCount();
                        }
                        else {
                            this.queueAutoRefresh();
                        }
    ...
    VirtualDataSource.prototype.getRootSummaryRowCount = function () {
        return this.shouldEmitSummaryRows ? this.d6 : 0;
    };
    ...
    VirtualDataSource.prototype.getSectionSummaryResults = function (a) {
        if (this.df.t.count > 0 && a >= 0 && a < this.df.t.count) {
            return this.df.t._inner[a].i;
        }
        return null;
    };
    ...
    VirtualDataSource.prototype.cq = function (a, b) {
        if (a == 5) {
            var c = b;
            var d_1 = c.a;
