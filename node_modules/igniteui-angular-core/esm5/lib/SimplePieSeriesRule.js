...
var SimplePieSeriesRule = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    SimplePieSeriesRule.d = function (a, b) {
    ...
    SimplePieSeriesRule.c = function (a, b) {
        return SimplePieSeriesRule.d(a.analyzer, b);
    };
    SimplePieSeriesRule.prototype.evaluate = function (a) {
        var b = SimplePieSeriesRule.c(a, this.distinctCheckThreshold);
        var c = null;
    ...
    SimplePieSeriesRule.prototype.e = function (a, b) {
    };
