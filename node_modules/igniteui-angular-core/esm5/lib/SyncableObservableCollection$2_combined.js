...
var SyncableObservableCollection$2 = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function SyncableObservableCollection$2($t1, $t2, a) {
        ...
        _this.$t2 = null;
        _this.a = null;
        _this.q = new List$1(SyncableObservableCollection$1.$.specialize(_this.$t2), 0);
        _this._compare = null;
            ...
            case 0:
                {
                    ...
                    _this.addListener(runOn(_this, _this.aj));
                    var c = _this._inner;
                    c.collectionChanged = delegateCombine(c.collectionChanged, runOn(_this, _this.x));
                }
                break;
            case 1:
                {
    ...
    SyncableObservableCollection$2.prototype.af = function (a, b) {
        if (a != null) {
            a.removeListener(runOn(this, this.ao));
        }
        this.al(this.a, false);
        if (b != null) {
            b.addListener(runOn(this, this.ao));
        }
    };
    ...
    SyncableObservableCollection$2.prototype.an = function (a, b) {
        var c = new List$1(Number_$type, 0);
        var d = 0;
        for (var e = 0; e < b.count; e++) {
    ...
    SyncableObservableCollection$2.prototype.ao = function (a, b) {
        ...
        var c = this.a.all;
        this.i = true;
        this.ak(this.$t1, this.$t2, b, this.all, c);
        this.i = false;
    };
    ...
    SyncableObservableCollection$2.prototype.aj = function (a, b) {
        ...
        if (this.a != null) {
            var c = this.a.all;
            this.g = true;
            this.ak(this.$t2, this.$t1, b, c, this.all);
            this.g = false;
        }
        if (this.q.count > 0) {
            for (var d = 0; d < this.q.count; d++) {
                var e = this.q._inner[d].all;
                this.g = true;
                this.ak(this.$t2, this.$t1, b, e, this.all);
                this.g = false;
            }
        }
    };
    SyncableObservableCollection$2.prototype.ak = function ($t, $f, a, b, c) {
        var e_2, _a;
        switch (a.action) {
            case 0:
                if (a.newItems != null) {
    ...
    SyncableObservableCollection$2.prototype.ac = function (a) {
        ...
        if (this._inner != null) {
            var c = this._inner;
            c.collectionChanged = delegateCombine(c.collectionChanged, runOn(this, this.x));
        }
    };
    SyncableObservableCollection$2.prototype.x = function (a, b) {
        var e_3, _a;
        if (this.f != null) {
            this.f();
        }
