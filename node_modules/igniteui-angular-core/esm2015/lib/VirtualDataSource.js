...
export let VirtualDataSource = /*@__PURE__*/ (() => {
    class VirtualDataSource extends BaseDataSource {
        constructor() {
            ...
            this.cz = null;
            this.c0 = null;
            this.dg = new LRUCache$2(Base.$, IDataSourcePage_$type, 0, 200);
            this.dn = new Dictionary$2(Base.$, Array_$type, 0);
            this.dp = new Dictionary$2(Number_$type, Number_$type, 0);
            this.di = false;
            this.cx = null;
            this.c1 = null;
            this.df = new SectionMap();
            this.cy = null;
            this.dy = -1;
            this.dr = -1;
            this.d0 = -1;
            ...
            this.dv = -1;
            this.dx = -1;
            this.dm = new Dictionary$2(String_$type, Boolean_$type, 0);
            this._concurrencyTag = null;
            this.batchStarted = null;
            this.batchCompleted = null;
            this.dd = new PagePredictionEngine();
            this.dd.e = this;
        ...
        ex(a, b, c) {
            ...
            if (this.summaryDescriptions.k.count > 0 && this.c1 == null && f != null) {
                this.c1 = f;
                for (let g = 0; g < this.c1.length; g++) {
                    this.c1[g].summaryIndex = this.d8(this.c1[g]);
                }
                let h = SectionData.r(this.c1);
                this.d6 = h.count;
            }
        ...
        ew() {
            ...
            for (let e = 0; e < this.cx.length; e++) {
                let f = new SectionData();
                let g = b;
                let h = this.cx[e].endIndex - this.cx[e].startIndex;
                f.af = a;
                f.ae = e;
            ...
            let u = 0;
            for (let v = 0; v < this.df.t.count; v++) {
                let w = this.df.t._inner[v];
        ...
        ep(a, b) {
            if (b) {
                ...
                for (let c = 0; c < this.cz.length; c++) {
                    this.cz[c] = a;
                }
            }
        ...
        removeCandidate(a) {
            if (this.dn.containsKey(a)) {
                for (let b = 0; b < this.dn.item(a).length; b++) {
                    let c = this.dn.item(a)[b];
                    this.es(c);
                }
        ...
        getUnrealizedCount() {
            let a = this.dg.g * this.actualPageSize;
        ...
        ey() {
            if (this.actualDataProvider != null) {
                for (let a of fromEnum(this.dn.values)) {
        ...
        indexOfKey(a) {
            ...
            if (this.aq && this.shouldEmitSectionHeaders && !this.isSectionContentVisible && this.isSectionHeaderNormalRow) {
                if (this.df.t.count > 0) {
                    for (let d = 0; d < this.df.t.count; d++) {
                        let e = this.df.t._inner[d];
