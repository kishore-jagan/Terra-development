...
export let CssVisibilityPropertyAccessor = /*@__PURE__*/ (() => {
    class CssVisibilityPropertyAccessor extends UIElementPropertyAccessor {
        b(a) {
            let b = a;
            let c = b.getStyleProperty("visibility");
            if (c != null) {
                switch (c.toLowerCase()) {
                    case "collapse":
                    case "hidden": return enumGetBox(Visibility_$type, 1);
                }
            }
        ...
        c(a, b) {
            let c = a;
            c.setStyleProperty("visibility", EnumUtil.getEnumValue(Visibility_$type, b) == 1 ? "collapse" : "visible");
        }
    }
