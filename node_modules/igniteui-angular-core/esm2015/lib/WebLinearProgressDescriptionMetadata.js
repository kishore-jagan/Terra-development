 ...
 * @hidden
 */
export let WebLinearProgressDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebLinearProgressDescriptionMetadata extends Base {
        static b(a) {
        ...
        static c(a) {
            ...
            a.item("LabelAlign@names", "Bottom;Top;TopStart;TopEnd;BottomStart;BottomEnd");
        }
        static d(a) {
            WebLinearProgressDescriptionMetadata.b(a);
            a.ae("WebLinearProgress", () => new WebLinearProgressDescription());
