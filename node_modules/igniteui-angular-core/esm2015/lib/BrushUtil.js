...
export let BrushUtil = /*@__PURE__*/ (() => {
    class BrushUtil extends Base {
        ...
        static m(a, b) {
            ...
            if (a.isGradient) {
                ...
                for (let d = 0; d < c.gradientStops.length; d++) {
                    ...
                    e.color = ColorUtil.x(e.color, b);
                }
                return c;
            }
            else {
                let f = ColorUtil.x(a.color, b);
                return ((() => {
                    let $ret = new Brush();
                    $ret.color = f;
                    return $ret;
        ...
        static s(a, b, c, d) {
            let e = new Brush();
            e.color = ColorUtil.w(a.color, b, c.color, d);
            return e;
        }
        static r(a, b, c, d) {
        ...
        static c(a, b, c, d) {
            ...
            for (let f = 0; f < c.length; ++f) {
                e[f] = ((() => {
                    ...
                    $ret.color = ColorUtil.w(a, b, c[f].color, d);
                    return $ret;
                })());
            }
            return e;
        ...
        static b(a, b, c, d) {
            ...
            for (; h < e; ++h) {
                g[h] = ((() => {
                    ...
                    $ret.color = ColorUtil.w(a[h].color, b, c[h].color, d);
                    return $ret;
                })());
            }
            for (; h < a.length; ++h) {
                g[h] = ((() => {
                    ...
                    $ret.color = ColorUtil.w(a[h].color, b, c[c.length - 1].color, d);
                    return $ret;
                })());
            }
            for (; h < c.length; ++h) {
                g[h] = ((() => {
                    ...
                    $ret.color = ColorUtil.w(a[a.length - 1].color, b, c[h].color, d);
                    return $ret;
                })());
            }
            return g;
        ...
        static f(palleteName_, container_, a, b, c = null) {
        ...
        static g(a, b, c, container_, d, e, f = null) {
