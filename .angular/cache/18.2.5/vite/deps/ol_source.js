...
} from "./chunk-7UYRMPU3.js";
import "./chunk-HJVVVDHP.js";
import {
  TileQueue_default
...
addDecoder([void 0, 1], () => import("./raw-A2VBSZEA.js").then((m) => m.default));
addDecoder(5, () => import("./lzw-PHV4ON5Z.js").then((m) => m.default));
addDecoder(6, () => {
  throw new Error("old style JPEG compression is not supported.");
});
addDecoder(7, () => import("./jpeg-K3BBHTE5.js").then((m) => m.default));
addDecoder([8, 32946], () => import("./deflate-GCDNPR2Y.js").then((m) => m.default));
addDecoder(32773, () => import("./packbits-SOESLBKV.js").then((m) => m.default));
addDecoder(34887, () => import("./lerc-Y5HUJX3A.js").then((m) => __async(void 0, null, function* () {
  yield m.zstd.init();
  return m;
})).then((m) => m.default));
addDecoder(50001, () => import("./webimage-KGJ6CWGI.js").then((m) => m.default));
  ...
  constructor(size = defaultPoolSize, createWorker2) {
    ...
    if (size) {
      this._awaitingDecoder = createWorker2 ? Promise.resolve(createWorker2) : new Promise((resolve) => {
        import("./decoder-QGLBYR6Z.js").then((module) => {
...
var VectorTile2 = class extends UrlTile_default {
  ...
  getSourceTiles(pixelRatio, projection, tile) {
    if (tile.getState() === TileState_default.IDLE) {
      ...
      sourceTileGrid.forEachTileCoord(extent, sourceZ, (sourceTileCoord) => {
        ...
        const sourceTile = this.sourceTileCache_.containsKey(tileUrl2) ? this.sourceTileCache_.get(tileUrl2) : new this.tileClass(sourceTileCoord, tileUrl2 ? TileState_default.IDLE : TileState_default.EMPTY, tileUrl2, this.format_, this.tileLoadFunction);
  ...
  getTile(z, x, y, pixelRatio, projection) {
    ...
    const newTile = new VectorRenderTile_default(tileCoord, empty ? TileState_default.EMPTY : TileState_default.IDLE, urlTileCoord, this.getSourceTiles.bind(this, pixelRatio, projection));
    newTile.key = this.getKey();
    return newTile;
  }
  /**
